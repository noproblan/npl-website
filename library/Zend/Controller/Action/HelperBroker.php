...
class Zend_Controller_Action_HelperBroker
{
    ...
    {
        if ((null !== $loader) &&
                 (! $loader instanceof Zend_Loader_PluginLoader_Interface)) {
     ...
     * @return void
     */
    static public function addHelper (
     ...
     * @param array $args            
     * @return mixed
     * @throws Zend_Controller_Action_Exception if helper does not have a
     *         direct() method
     */
    ...
    protected static function _loadHelper ($name)
    {
        try {
            ...
            require_once 'Zend/Controller/Action/Exception.php';
            throw new Zend_Controller_Action_Exception(
                    'Action Helper by name ' . $name . ' not found', 0, $e);
        }
