...
class Zend_Controller_Action_Helper_ActionStack extends Zend_Controller_Action_Helper_Abstract
{
     ...
     * @return Zend_Controller_Action_Helper_ActionStack Provides a fluent
     *         interface
     */
            ...
            array $params = array())
    {
        ...
        $newRequest = new Zend_Controller_Request_Simple($action, $controller, 
                $module, $params);
    ...
    /**
     * Perform helper when called as $this->_helper->actionStack() from an
     * action controller
     *
