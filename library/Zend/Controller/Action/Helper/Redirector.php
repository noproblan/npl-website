...
class Zend_Controller_Action_Helper_Redirector extends Zend_Controller_Action_Helper_Abstract
{
     ...
     *
     * @param int $code            
     * @return Zend_Controller_Action_Helper_Redirector Provides a fluent
     *         interface
     */
    ...
    /**
     * Retrieve flag for whether or not {@link _redirect()} will exit when
     * finished.
     *
     * @return boolean
     */
    ...
    /**
     * Retrieve flag for whether or not {@link redirectAndExit()} shall close
     * the session before
     * exiting.
     *
     * @return boolean
    ...
    /**
     * Set flag for whether or not {@link redirectAndExit()} shall close the
     ...
     * - exit: boolean flag indicating whether or not to halt script execution
     * when done
     * - prependBase: boolean flag indicating whether or not to prepend the base
     * URL when a relative URL is provided
     * - code: integer HTTP status code to use with redirect. Should be between
     * 300 and 307.
     *
    ...
    /**
     * Perform a redirect to an action/controller/module with params, forcing an
     * immdiate exit
     *
     * @param mixed $action            
