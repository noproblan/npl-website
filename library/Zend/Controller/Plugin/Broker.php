...
class Zend_Controller_Plugin_Broker extends Zend_Controller_Plugin_Abstract
{
        ...
        if ($stackIndex) {
            if (isset($this->_plugins[$stackIndex])) {
                ...
                throw new Zend_Controller_Exception(
                        'Plugin with stackIndex "' . $stackIndex .
                                 '" already registered');
            }
    ...
    public function unregisterPlugin ($plugin)
    {
        if ($plugin instanceof Zend_Controller_Plugin_Abstract) {
            ...
            // Given a plugin class, find all plugins of that class and unset
            // them
     ...
     * @return false|Zend_Controller_Plugin_Abstract|array Returns false if none
     *         found, plugin if only one found, and array of plugins if multiple
        ...
        foreach ($this->_plugins as $plugin) {
            try {
                ...
                if (Zend_Controller_Front::getInstance()->throwExceptions()) {
                    ...
                    $this->getResponse()->setException($e);
                    // skip rendering of normal dispatch give the error handler
                    // a try
