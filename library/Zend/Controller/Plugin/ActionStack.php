...
class Zend_Controller_Plugin_ActionStack extends Zend_Controller_Plugin_Abstract
{
    ...
    /**
     * Flag to determine whether request parameters are cleared between actions,
     * or whether new parameters
    ...
    /**
     * postDispatch() plugin hook -- check for actions in stack, and dispatch if
     * any found
     *
