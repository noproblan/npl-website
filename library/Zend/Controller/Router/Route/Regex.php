...
class Zend_Controller_Router_Route_Regex extends Zend_Controller_Router_Route_Abstract
{
     ...
     * counterpart.
     * Or vice versa. Uses user provided map array which consists of index =>
     * name
     ...
     * array is
     * indexed numerically then every associative key will be stripped. Vice
     * versa if reversed
     * is set to true.
     *
     * @param array $values
     ...
     *            False means translation of index to association. True means
     *            reverse.
    ...
    public function assemble ($data = array(), $reset = false, $encode = false, $partial = false)
    {
        ...
        // merge all the data together, first defaults, then values matched,
        // then supplied
        ...
        if ($return === false) {
            require_once 'Zend/Controller/Router/Exception.php';
            throw new Zend_Controller_Router_Exception(
                    'Cannot assemble. Too few arguments?');
        }
    ...
    /**
     * _arrayMergeNumericKeys() - allows for a strict key (numeric's included)
     * array_merge.
