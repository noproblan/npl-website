...
interface Zend_Controller_Router_Interface
{
     ...
     *
     * May be passed user params to override ones from URI, Request or even
     * defaults.
     * If passed parameter has a value of null, it's URL variable will be reset
     * to
     * default.
     *
     ...
     *
     * Reset is used to signal that all parameters should be reset to it's
     * defaults.
     * Ignoring all URL specified values. User specified params still get
     * precedence.
     *
