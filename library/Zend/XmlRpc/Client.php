...
class Zend_XmlRpc_Client
{
     ...
     */
    public function setIntrospector (
            Zend_XmlRpc_Client_ServerIntrospection $introspector)
    {
    ...
    /**
     * Skip system lookup when determining if parameter should be array or
     * struct?
     *
     * @return bool
     */
    ...
    public function doRequest ($request, $response = null)
    {
        ...
        if (! $httpResponse->isSuccessful()) {
            ...
            throw new Zend_XmlRpc_Client_HttpException(
                    $httpResponse->getMessage(), $httpResponse->getStatus());
        }
    ...
    public function call ($method, $params = array())
    {
        if (! $this->skipSystemLookup() && ('system.' != substr($method, 0, 7))) {
            ...
            $success = true;
            try {
                $signatures = $this->getIntrospector()->getMethodSignature(
                        $method);
            ...
            if ($success) {
                ...
                foreach ($params as $key => $param) {
                    ...
                    $params[$key] = Zend_XmlRpc_Value::getXmlRpcValue($param, 
                            $type);
                }
            }
        }
