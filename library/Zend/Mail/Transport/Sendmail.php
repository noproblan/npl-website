...
class Zend_Mail_Transport_Sendmail extends Zend_Mail_Transport_Abstract
{
    ...
    public function _sendMail ()
    {
        if ($this->parameters === null) {
            ...
            $result = mail($this->recipients, $this->_mail->getSubject(), 
            ...
            if (! is_string($this->parameters)) {
                /**
                 *
                 * @see Zend_Mail_Transport_Exception Exception is thrown here
                 *      because
            ...
            $result = mail($this->recipients, $this->_mail->getSubject(), 
                    $this->body, $this->header, $this->parameters);
            restore_error_handler();
        }
        ...
        if ($this->_errstr !== null || ! $result) {
            ...
            require_once 'Zend/Mail/Transport/Exception.php';
            throw new Zend_Mail_Transport_Exception(
                    'Unable to send mail. ' . $this->_errstr);
        }
    }
     ...
     * @return true
     */
    public function _handleMailErrors ($errno, $errstr, $errfile = null, 
