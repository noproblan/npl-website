 ...
 *
 * Zend_Crypt_Math_BigInteger is a wrapper across three PHP extensions: bcmath,
 * gmp
...
class Zend_Crypt_Math_BigInteger
{
    ...
    public function __construct ($extension = null)
    {
        if ($extension !== null &&
            ...
            throw new Zend_Crypt_Math_BigInteger_Exception(
    ...
    protected function _loadAdapter ($extension = null)
    {
        ...
        if ($extension == 'gmp' && extension_loaded('gmp')) {
            ...
            throw new Zend_Crypt_Math_BigInteger_Exception(
                    $extension .
                             ' big integer precision math support not detected');
        }
    }
}