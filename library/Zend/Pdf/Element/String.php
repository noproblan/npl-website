...
class Zend_Pdf_Element_String extends Zend_Pdf_Element
{
    ...
    public static function unescape ($str)
    {
        ...
        while ($offset < strlen($str)) {
            ...
            if ($escapeCharOffset === false ||
                     $escapeCharOffset == strlen($str) - 1) {
                // There are no escaped characters or '\' char has came at the
                // end of string
                    ...
                    default:
                        if (strpos('0123456789', $str[$offset]) !== false) {
                            ...
                            if (strpos('0123456789', $str[$offset + 1]) !== false) {
                                ...
                                if (strpos('0123456789', $str[$offset + 1]) !==
                                         false) {
                                    $nextCode .= $str[++ $offset];
                                }
                            }
