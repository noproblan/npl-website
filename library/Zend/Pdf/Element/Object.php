...
class Zend_Pdf_Element_Object extends Zend_Pdf_Element
{
     ...
     */
    public function __construct (Zend_Pdf_Element $val, $objNum, $genNum, 
            ...
            array &$processed, $mode)
    {
        ...
        $processed[$id] = $clonedObject = $factory->newObject(
        ...
        if ($clonedObject->_value instanceof Zend_Pdf_Element_Null) {
            // Do not store null objects within $processed container since it
            // may be filtered
