 ...
 *
 * Thes class allows to extract fonts already mentioned within PDF document and
 * use them
 * for text drawing.
 *
 * @package Zend_Pdf
...
class Zend_Pdf_Resource_Font_Extracted extends Zend_Pdf_Resource_Font
{
     ...
     * Object constructor
     *
     * $fontDictionary is a Zend_Pdf_Element_Reference or
     * Zend_Pdf_Element_Object object
     *
    ...
    {
        // Extract object factory and resource object from font dirctionary
        // object
        ...
        switch ($fontDictionary->Subtype->value) {
            ...
            case 'Type1':
                if ($fontDictionary->FontDescriptor === null) {
                    ...
                    $standardFont = Zend_Pdf_Font::fontWithName(
        ...
        $this->_fontNames[Zend_Pdf_Font::NAME_POSTSCRIPT]['en'] = iconv('UTF-8', 
                'UTF-16BE', $fontDictionary->BaseFont->value);
        
        $this->_isBold = false; // this property is actually not
                                            // used anywhere
        $this->_isItalic = (($fontDescriptor->Flags->value & (1 << 6)) != 0); // Bit-7
                                                                                          // is
                                                                                          // set
        $this->_isMonospace = (($fontDescriptor->Flags->value & (1 << 0)) != 0); // Bit-1
                                                                                          // is
                                                                                          // set
