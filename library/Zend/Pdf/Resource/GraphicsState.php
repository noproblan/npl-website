 ...
 * Graphics State.
 *
 * While some parameters in the graphics state can be set with individual
 * operators,
 * as shown in Table 4.7, others cannot. The latter can only be set with the
 * generic
    ...
    public function __construct (Zend_Pdf_Element_Object $extGStateObject = null)
    {
        ...
        if ($extGStateObject->getType() != Zend_Pdf_Element::TYPE_DICTIONARY) {
            ...
            throw new Zend_Pdf_Exception(
                    'Graphics state PDF object must be a dictionary');
        }
