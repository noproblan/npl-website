...
abstract class Zend_Pdf_Resource
{
     ...
     * It creates appropriate PDF objects, structures and sometime embedded
     * files.
     ...
     *
     * Resource abstraction uses own PDF object factory to store all necessary
     * information.
     * At the render time internal object factory is appended to the global PDF
     * file
     * factory.
     *
     * Resource abstraction also cashes information about rendered PDF files and
     * doesn't duplicate resource description each time then Resource is
     * rendered
     * (referenced).
     *
     ...
     * Object constructor.
     *
     * If resource is not a Zend_Pdf_Element object, then stream object with
     * specified value is
     * generated.
     *
     ...
     */
        ...
        // // Do it explicitly to prevent sharing resource attributes between
    // different
        // // results of clone operation (other resources are still shared)
        // $dictionary = new Zend_Pdf_Element_Dictionary();
        // foreach ($this->_pageDictionary->getKeys() as $key) {
        // $dictionary->$key =
    // $this->_pageDictionary->$key->makeClone($factory->getFactory(),
        // $processed,
    ...
    /**
     * Clone resource, extract it and dependent objects from the current
     * document,
     * so it can be used within other docs.
     *
     * @internal
     ...
     */
        ...
        // // Clone dictionary object.
        // // Do it explicitly to prevent sharing page attributes between
    // different
        // // results of clonePage() operation (other resources are still
    // shared)
        // $dictionary = new Zend_Pdf_Element_Dictionary();
        // foreach ($this->_pageDictionary->getKeys() as $key) {
        // $dictionary->$key =
    ...
    /**
     * Get resource.
     * Used to reference resource in an internal PDF data structures (resource
     * dictionaries)
     *
     * @internal
     *
