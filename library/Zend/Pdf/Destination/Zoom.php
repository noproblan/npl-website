 ...
 * magnified by the factor zoom. A null value for any of the parameters left,
 * top,
...
class Zend_Pdf_Destination_Zoom extends Zend_Pdf_Destination_Explicit
{
    ...
    /**
     * Get left edge of the displayed page (null means viewer application
     * 'current value')
     *
     * @return float
     */
    ...
    /**
     * Set left edge of the displayed page (null means viewer application
     * 'current value')
     *
     * @param float $left            
    ...
    public function setLeftEdge ($left)
    {
        if ($left === null) {
            ...
            $this->_destinationArray->items[2] = new Zend_Pdf_Element_Numeric(
                    $left);
        }
    ...
    /**
     * Get top edge of the displayed page (null means viewer application
     * 'current value')
     *
     * @return float
     */
    ...
    /**
     * Set top edge of the displayed page (null means viewer application
     * 'current viewer')
     *
     * @param float $top            
     * @return Zend_Pdf_Action_Zoom
    ...
    public function setTopEdge ($top)
    {
        if ($top === null) {
            ...
            $this->_destinationArray->items[3] = new Zend_Pdf_Element_Numeric(
                    $top);
        }
    ...
    /**
     * Get ZoomFactor of the displayed page (null or 0 means viewer application
     * 'current value')
     *
     * @return float
     */
    ...
    /**
     * Set ZoomFactor of the displayed page (null or 0 means viewer application
     * 'current viewer')
     *
     * @param float $zoom            
     * @return Zend_Pdf_Action_Zoom
    ...
    public function setZoomFactor ($zoom)
    {
        if ($zoom === null) {
            ...
            $this->_destinationArray->items[4] = new Zend_Pdf_Element_Numeric(
                    $zoom);
        }
