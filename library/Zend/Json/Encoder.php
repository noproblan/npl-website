...
class Zend_Json_Encoder
{
     ...
     * @param boolean $cycleCheck
     *            Whether or not to check for possible object recursion when
     *            encoding
     * @param array $options
     *            Additional options used during encoding
     ...
     * @param object $value            
     * @return string
     * @throws Zend_Json_Exception If recursive checks are enabled and the
        ...
        foreach ($methods as $method) {
            ...
            if ('__construct' != $method->getName()) {
                ...
                $result .= "){" . $argNames .
                         ...
                         "this, '" . $method->getName() .
                         "',argNames,arguments);" . 'return(result);}';
            } else {
                $result .= "){}";
            }
        }
    ...
    public static function encodeClass ($className, $package = '')
    {
        ...
        return "Class.create('$package$className',{" .
                 self::_encodeConstants($cls) . "," . self::_encodeMethods($cls) .
