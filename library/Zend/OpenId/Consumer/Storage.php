...
abstract class Zend_OpenId_Consumer_Storage
{
     ...
     * @return void
     */
    abstract public function addAssociation ($url, $handle, $macFunc, $secret, 
            $expires);
     ...
     * @return bool
     */
    abstract public function getAssociation ($url, &$handle, &$macFunc, &$secret, 
            &$expires);
     ...
     * @return bool
     */
    abstract public function getAssociationByHandle ($handle, &$url, &$macFunc, 
            &$secret, &$expires);
     ...
     * @return bool
     */
    abstract public function getDiscoveryInfo ($id, &$realId, &$server, 
            &$version, &$expires);
