...
class Zend_Dojo_View_Helper_Dojo_Container
{
     ...
     *
     * @param
     *            array|Zend_Config Array or Zend_Config object with options to
     *            use
     * @return Zend_Dojo_View_Helper_Dojo_Container
     */
    ...
    public function addDijit ($id, array $params)
    {
        if (array_key_exists($id, $this->_dijits)) {
            require_once 'Zend/Dojo/View/Exception.php';
            throw new Zend_Dojo_View_Exception(
                    sprintf('Duplicate dijit with id "%s" already registered', 
                            $id));
        }
    ...
    public function dijitsToJson ()
    {
        ...
        return Zend_Json::encode($this->getDijits(), false, 
                array(
