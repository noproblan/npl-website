...
class Zend_Config_Xml extends Zend_Config
{
     ...
     * @throws Zend_Config_Exception When section $sectionName cannot be found
     *         in $xml
     */
            ...
            if (is_array($section)) {
                ...
                foreach ($section as $sectionName) {
                    ...
                    $dataArray = array_merge(
                            $this->_processExtends($config, $sectionName), 
                            $dataArray);
                }
                ...
                if (! is_array($dataArray)) {
                    // Section in the XML file contains just one top level
                    // string
                    $dataArray = array(
                            $section => $dataArray
                    );
    ...
    /**
     * Returns a string or an associative and possibly multidimensional array
     * from
     * a SimpleXMLElement.
     *
    ...
    protected function _toArray (SimpleXMLElement $xmlObject)
    {
        ...
        if (count($xmlObject->children()) > 0) {
            ...
            if (! isset($xmlObject['extends']) &&
                ...
                // Object has no children nor attributes and doesn't use the
                // extends
