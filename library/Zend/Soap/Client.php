...
class Zend_Soap_Client
{
     ...
     * @return Zend_Soap_Client
     * @throws Zend_Soap_Client_Exception with invalid message encoding method
     *         argument
     */
     ...
     * @return Zend_Soap_Client
     * @throws Zend_Soap_Client_Exception with invalid local certificate path
     *         argument
     */
    public function setHttpsCertificate ($localCert)
    {
        if (! is_readable($localCert)) {
            require_once 'Zend/Soap/Client/Exception.php';
            throw new Zend_Soap_Client_Exception(
                    'Invalid HTTPS client certificate path.');
        }
     ...
     * @return mixed
     */
    public function _doRequest (Zend_Soap_Client_Common $client, $request, 
            $location, $action, $version, $one_way = null)
    {
    ...
    protected function _initSoapClientObject ()
    {
        ...
        $this->_soapClient = new Zend_Soap_Client_Common(
                array(
                        $this,
                        '_doRequest'
                ), $wsdl, $options);
    ...
    public function __call ($name, $arguments)
    {
        ...
        $soapHeaders = array_merge($this->_permanentSoapInputHeaders, 
                $this->_soapInputHeaders);
        $result = $soapClient->__soapCall($name, 
                $this->_preProcessArguments($arguments), null, /* Options are already set to the SOAP client object */
    ...
    public function getFunctions ()
    {
        if ($this->getWsdl() == null) {
            require_once 'Zend/Soap/Client/Exception.php';
            throw new Zend_Soap_Client_Exception(
                    '\'getFunctions\' method is available only in WSDL mode.');
        }
    ...
    public function getTypes ()
    {
        if ($this->getWsdl() == null) {
            require_once 'Zend/Soap/Client/Exception.php';
            throw new Zend_Soap_Client_Exception(
                    '\'getTypes\' method is available only in WSDL mode.');
        }
