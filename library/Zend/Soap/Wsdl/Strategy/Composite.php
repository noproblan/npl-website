 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_Soap_Wsdl_Strategy_Composite implements 
        Zend_Soap_Wsdl_Strategy_Interface
{
    ...
    public function getStrategyOfType ($type)
    {
        if (isset($this->_typeMap[$type])) {
            ...
            if (! ($strategy instanceof Zend_Soap_Wsdl_Strategy_Interface)) {
                ...
                require_once "Zend/Soap/Wsdl/Exception.php";
                throw new Zend_Soap_Wsdl_Exception(
                        "Strategy for Complex Type '" . $type .
                                 "' is not a valid strategy object.");
            }
            $this->_typeMap[$type] = $strategy;
        } else {
    ...
    public function addComplexType ($type)
    {
        if (! ($this->_context instanceof Zend_Soap_Wsdl)) {
            ...
            require_once "Zend/Soap/Wsdl/Exception.php";
            throw new Zend_Soap_Wsdl_Exception(
                    "Cannot add complex type '" . $type .
                             "', no context is set for this composite strategy.");
        }
