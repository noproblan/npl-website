...
class Zend_Translate
{
    ...
    public function setAdapter ($options = array())
    {
        ...
        if (Zend_Loader::isReadable(
                'Zend/Translate/Adapter/' . ucfirst($options['adapter']) . '.php')) {
            $options['adapter'] = 'Zend_Translate_Adapter_' .
                     ucfirst($options['adapter']);
        }
        ...
        if (! $this->_adapter instanceof Zend_Translate_Adapter) {
            ...
            throw new Zend_Translate_Exception(
                    "Adapter " . $adapter .
                             " does not extend Zend_Translate_Adapter");
        }
    }
