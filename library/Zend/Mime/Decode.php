...
class Zend_Mime_Decode
{
    ...
    {
        // TODO: we're ignoring \r for now - is this function fast enough and is
        // it safe to asume noone needs \r?
     ...
     * @return array|null parts as array('header' => array(name => value),
     *         'body' => content), null if no parts found
     * @throws Zend_Exception
     */
            ...
            $EOL = Zend_Mime::LINEEND)
    {
        ...
        if (! preg_match('%^[^\s]+[^:]*:%', $firstline)) {
            $headers = array();
            // TODO: we're ignoring \r for now - is this function fast enough
            // and is it safe to asume noone needs \r?
     ...
     * @throws Zend_Exception
     */
    public static function splitHeaderField ($field, $wantedPart = null, 
            $firstName = 0)
    {
