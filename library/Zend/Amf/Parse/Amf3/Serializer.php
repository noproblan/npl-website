...
class Zend_Amf_Parse_Amf3_Serializer extends Zend_Amf_Parse_Serializer
{
    ...
    public function writeTypeMarker (&$data, $markerType = null, $dataByVal = false)
    {
        ...
        if (null !== $markerType) {
            // Write the Type Marker to denote the following action script data
            // type
            ...
            switch ($markerType) {
                ...
                default:
                    ...
                    throw new Zend_Amf_Exception(
                            'Unknown Type Marker: ' . $markerType);
            }
        } else {
            // Detect Type Marker
            if (is_resource($data)) {
            ...
            switch (true) {
                ...
                default:
                    require_once 'Zend/Amf/Exception.php';
                    throw new Zend_Amf_Exception(
                            'Unsupported data type: ' . gettype($data));
            }
    ...
    public function writeByteArray (&$data)
    {
        ...
        if (is_string($data)) {
            ...
            if ($data instanceof Zend_Amf_Value_ByteArray) {
                ...
                require_once 'Zend/Amf/Exception.php';
                throw new Zend_Amf_Exception(
                        'Invalid ByteArray specified; must be a string or Zend_Amf_Value_ByteArray');
            }
        ...
        if (is_string($xml)) {
            ...
            if ($xml instanceof DOMDocument) {
                ...
                if ($xml instanceof SimpleXMLElement) {
                    ...
                    require_once 'Zend/Amf/Exception.php';
                    throw new Zend_Amf_Exception(
                            'Invalid xml specified; must be a DOMDocument or SimpleXMLElement');
                }
    ...
    public function writeDate ($date)
    {
        ...
        if ($date instanceof DateTime) {
            ...
            require_once 'Zend/Amf/Exception.php';
            throw new Zend_Amf_Exception(
                    'Invalid date specified; must be a string DateTime or Zend_Date object');
        }
    ...
    /**
     * Check if the given object is in the reference table, write the reference
     * if it exists,
    ...
    public function writeObject ($object)
    {
        ...
        switch (true) {
            ...
            case ($className = Zend_Amf_Parse_TypeLoader::getMappedClassName(
                    get_class($object))):
                break;
            
            // Check to see if the user has defined an explicit Action Script
            // type.
            case isset($object->_explicitType):
                $className = $object->_explicitType;
                break;
            
            // Check if user has defined a method for accessing the Action
            // Script type
        ...
        if (array_key_exists($className, $this->_referenceDefinitions)) {
            ...
            if ($className == '') {
                // if there is no className, we interpret the class as dynamic
                // without any sealed members
        ...
        try {
            switch ($encoding) {
                ...
                case Zend_Amf_Constants::ET_EXTERNAL:
                    require_once 'Zend/Amf/Exception.php';
                    throw new Zend_Amf_Exception(
                            'External Object Encoding not implemented');
                    break;
                default:
                    require_once 'Zend/Amf/Exception.php';
                    throw new Zend_Amf_Exception(
            ...
            require_once 'Zend/Amf/Exception.php';
            throw new Zend_Amf_Exception(
                    'Unable to writeObject output: ' . $e->getMessage(), 0, $e);
        }
