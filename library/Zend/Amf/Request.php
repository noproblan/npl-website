 ...
 *
 * @todo Currently not checking if the object needs to be Type Mapped to a
 *       server object.
 * @package Zend_Amf
...
class Zend_Amf_Request
{
    ...
    public function initialize ($request)
    {
        ...
        $this->_deserializer = new Zend_Amf_Parse_Amf0_Deserializer(
                $this->_inputStream);
    ...
    public function readHeader ()
    {
        ...
        try {
            ...
            require_once 'Zend/Amf/Exception.php';
            throw new Zend_Amf_Exception(
                    'Unable to parse ' . $name . ' header data: ' .
                             $e->getMessage() . ' ' . $e->getLine(), 0, $e);
        }
        
        $header = new Zend_Amf_Value_MessageHeader($name, $mustRead, $data, 
                $length);
        return $header;
    }
    ...
    public function readBody ()
    {
        ...
        try {
            ...
            require_once 'Zend/Amf/Exception.php';
            throw new Zend_Amf_Exception(
                    'Unable to parse ' . $targetURI . ' body data ' .
                             $e->getMessage(), 0, $e);
        }
        ...
        if ($this->_deserializer->getObjectEncoding() ==
             ...
             */
            if (is_array($data) &&
             $data[0] instanceof Zend_Amf_Value_Messaging_AbstractMessage) {
        $data = $data[0];
    }
