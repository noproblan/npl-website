...
class Zend_Queue_Stomp_Client
{
    ...
    public function __construct ($scheme = null, $host = null, $port = null, 
            $connectionClass = 'Zend_Queue_Stomp_Client_Connection', $frameClass = 'Zend_Queue_Stomp_Frame')
    {
     ...
     *            support Zend_Queue_Stomp_Client_ConnectionInterface
     * @return boolean
     */
    public function addConnection ($scheme, $host, $port, 
