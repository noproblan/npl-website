 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
abstract class Zend_Queue_Adapter_AdapterAbstract implements 
        Zend_Queue_Adapter_AdapterInterface
{
     ...
     * adapters:
     *
     * See the Zend_Queue Adapter Notes documentation for example
     * configurations.
     *
    ...
    public function __construct ($options, Zend_Queue $queue = null)
    {
        ...
        if (! is_array($options)) {
            ...
            throw new Zend_Queue_Exception(
                    'Adapter options must be an array or Zend_Config object');
        }
        ...
        if (array_key_exists('options', $options)) {
            if (! is_array($options['options'])) {
                require_once 'Zend/Queue/Exception.php';
                throw new Zend_Queue_Exception(
                        "Configuration array 'options' must be an array");
            }
