...
class Zend_Text_Table_Column
{
    ...
    public function setColSpan ($colSpan)
    {
        if (is_int($colSpan) === false or $colSpan < 1) {
            ...
            throw new Zend_Text_Table_Exception(
                    '$colSpan must be an integer and greater than 0');
        }
     ...
     * @throws Zend_Text_Table_Exception When padding is greater than
     *         columnWidth
     * @return string
     */
    public function render ($columnWidth, $padding = 0)
    {
        if (is_int($columnWidth) === false or $columnWidth < 1) {
            require_once 'Zend/Text/Table/Exception.php';
            throw new Zend_Text_Table_Exception(
                    '$columnWidth must be an integer and greater than 0');
        }
        ...
        if ($columnWidth < 1) {
            require_once 'Zend/Text/Table/Exception.php';
            throw new Zend_Text_Table_Exception(
                    'Padding (' . $padding . ') is greater than column width');
        }
        ...
        foreach ($lines as $line) {
            $paddedLines[] = str_repeat(' ', $padding) .
                     Zend_Text_MultiByte::strPad($line, $columnWidth, ' ', 
                            $padMode, $outputCharset) . str_repeat(' ', $padding);
        }
