...
class Zend_Form_Decorator_Captcha_ReCaptcha extends Zend_Form_Decorator_Abstract
{
    ...
    public function render ($content)
    {
        ...
        $challengeName = empty($name) ? 'recaptcha_challenge_field' : $name .
                 '[recaptcha_challenge_field]';
        $responseName = empty($name) ? 'recaptcha_response_field' : $name .
        ...
        // Placing "id" in "attribs" to ensure it is not overwritten with the
        // name
