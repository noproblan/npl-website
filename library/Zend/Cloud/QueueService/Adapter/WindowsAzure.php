...
class Zend_Cloud_QueueService_Adapter_WindowsAzure extends Zend_Cloud_QueueService_Adapter_AbstractAdapter
{
    ...
    public function __construct ($options = array())
    {
        ...
        if (! isset($options[self::ACCOUNT_NAME])) {
            throw new Zend_Cloud_Storage_Exception(
    ...
    public function createQueue ($name, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on queue creation: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function deleteQueue ($queueId, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on queue deletion: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function listQueues ($options = null)
    {
        ...
        try {
            ...
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on listing queues: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function fetchQueueMetadata ($queueId, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on fetching queue metadata: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function storeQueueMetadata ($queueId, $metadata, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on setting queue metadata: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function sendMessage ($queueId, $message, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on sending message: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function receiveMessages ($queueId, $max = 1, $options = null)
    {
        try {
            ...
            return $this->_makeMessages(
                    $this->_storageClient->getMessages($queueId, $max, 
                            $visibility, false));
        } catch (Zend_Service_WindowsAzure_Exception $e) {
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on recieving messages: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function deleteMessage ($queueId, $message, $options = null)
    {
        try {
            ...
            if ($message instanceof Zend_Service_WindowsAzure_Storage_QueueMessage) {
                ...
                throw new Zend_Cloud_QueueService_Exception(
                        'Cannot delete the message: message object required');
            }
        } catch (Zend_Service_WindowsAzure_Exception $e) {
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on deleting a message: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
    ...
    public function peekMessages ($queueId, $num = 1, $options = null)
    {
        try {
            ...
            return $this->_makeMessages(
                    $this->_storageClient->peekMessages($queueId, $num));
        } catch (Zend_Service_WindowsAzure_Exception $e) {
            throw new Zend_Cloud_QueueService_Exception(
                    'Error on peeking messages: ' . $e->getMessage(), 
                    $e->getCode(), $e);
        }
    }
