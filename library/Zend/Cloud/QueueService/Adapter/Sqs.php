...
class Zend_Cloud_QueueService_Adapter_Sqs extends Zend_Cloud_QueueService_Adapter_AbstractAdapter
{
    ...
    public function __construct ($options = array())
    {
        ...
        if (isset($options[self::HTTP_ADAPTER])) {
            $this->_sqs->getHttpClient()->setAdapter(
    ...
    public function deleteQueue ($queueId, $options = null)
    {
        try {
            ...
            throw Zend_Cloud_QueueService_Exception(
    ...
    {
        try {
            // TODO: ZF-9050 Fix the SQS client library in trunk to return all
            // attribute values
    ...
    public function storeQueueMetadata ($queueId, $metadata, $options = null)
    {
        ...
        throw new Zend_Cloud_OperationNotAvailableException(
                'Amazon SQS doesn\'t currently support storing metadata');
    }
