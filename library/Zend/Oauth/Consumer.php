...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    public function getRequestToken (array $customServiceParameters = null, 
            $httpMethod = null, Zend_Oauth_Http_RequestToken $request = null)
    {
        if ($request === null) {
            $request = new Zend_Oauth_Http_RequestToken($this, 
    ...
    {
        if ($redirect === null) {
            $redirect = new Zend_Oauth_Http_UserAuthorization($this, 
                    $customServiceParameters);
        } elseif ($customServiceParameters !== null) {
            ...
            Zend_Oauth_Http_UserAuthorization $request = null)
    {
        ...
        $redirectUrl = $this->getRedirectUrl($customServiceParameters, $token, 
                $request);
     ...
     * @throws Zend_Oauth_Exception on invalid authorization token, non-matching
     *         response authorization token, or unprovided authorization token
     */
            ...
            $httpMethod = null, Zend_Oauth_Http_AccessToken $request = null)
    {
        ...
        if ($authorizedToken->getParam('oauth_verifier') !== null) {
            $params = array_merge($request->getParameters(), 
                    array(
                            'oauth_verifier' => $authorizedToken->getParam(
                                    'oauth_verifier')
                    ));
        ...
        if (isset($token)) {
            ...
            require_once 'Zend/Oauth/Exception.php';
            throw new Zend_Oauth_Exception(
                    'Request token must be passed to method');
        }
        $this->_requestToken = $token;
