...
class Zend_Auth_Adapter_OpenId implements Zend_Auth_Adapter_Interface
{
    ...
    public function __construct ($id = null, 
            Zend_OpenId_Consumer_Storage $storage = null, $returnTo = null, $root = null, 
    ...
    public function authenticate ()
    {
        ...
        if (! empty($id)) {
            ...
            if (! $this->_check_immediate) {
                if (! $consumer->login($id, $this->_returnTo, $this->_root, 
                        $this->_extensions, $this->_response)) {
                    return new Zend_Auth_Result(Zend_Auth_Result::FAILURE, $id, 
                            array(
                ...
                if (! $consumer->check($id, $this->_returnTo, $this->_root, 
                        $this->_extensions, $this->_response)) {
                    return new Zend_Auth_Result(Zend_Auth_Result::FAILURE, $id, 
                            array(
                                    "Authentication failed",
