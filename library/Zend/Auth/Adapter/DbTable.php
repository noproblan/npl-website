...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
    ...
    /**
     * $_credentialTreatment - Treatment applied to the credential, such as
     * MD5() or PASSWORD()
     *
     * @var string
     */
    ...
    /**
     * setIdentityColumn() - set the column name to be used as the identity
     * column
     *
     * @param string $identityColumn            
     * @return Zend_Auth_Adapter_DbTable Provides a fluent interface
    ...
    /**
     * setCredentialTreatment() - allows the developer to pass a parameterized
     * string that is
     * used to transform or treat the input credential data.
     *
     * In many cases, passwords and other sensitive data are encrypted, hashed,
     * encoded,
     * obscured, or otherwise treated through some function or algorithm. By
     * specifying a
     * parameterized treatment string with this method, a developer may apply
     * arbitrary SQL
    ...
    /**
     * setCredential() - set the credential value to be used, optionally can
     * specify a treatment
     * to be used, should be supplied in parameterized form, such as 'MD5(?)' or
     * 'PASSWORD(?)'
     *
    ...
    public function authenticate ()
    {
        ...
        if (($authResult = $this->_authenticateValidateResultSet(
                $resultIdentities)) instanceof Zend_Auth_Result) {
            return $authResult;
        }
        
        if (true === $this->getAmbiguityIdentity()) {
            $validIdentities = array();
            $zendAuthCredentialMatchColumn = $this->_zendDb->foldCase(
    ...
    /**
     * _authenticateCreateSelect() - This method creates a Zend_Db_Select object
     * that
    ...
    /**
     * _authenticateQuerySelect() - This method accepts a Zend_Db_Select object
     * and
    ...
    protected function _authenticateQuerySelect (Zend_Db_Select $dbSelect)
    {
        try {
            ...
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new Zend_Auth_Adapter_Exception(
                    'The supplied parameters to Zend_Auth_Adapter_DbTable failed to ' .
    ...
    {
        return new Zend_Auth_Result($this->_authenticateResultInfo['code'], 
