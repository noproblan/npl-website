...
class Zend_Translate_Plural
{
    ...
    public static function getPlural ($number, $locale)
    {
        ...
        switch ($locale) {
            ...
            case 'sr':
            case 'uk':
                return (($number % 10 == 1) && ($number % 100 != 11)) ? 0 : ((($number %
                         10 >= 2) && ($number % 10 <= 4) &&
            ...
            case 'sl':
                return ($number % 100 == 1) ? 0 : (($number % 100 == 2) ? 1 : ((($number %
                         100 == 3) || ($number % 100 == 4)) ? 2 : 3));
            ...
            case 'mt':
                return ($number == 1) ? 0 : ((($number == 0) ||
                         (($number % 100 > 1) && ($number % 100 < 11))) ? 1 : ((($number %
                         100 > 10) && ($number % 100 < 20)) ? 2 : 3));
            ...
            case 'ar':
                return ($number == 0) ? 0 : (($number == 1) ? 1 : (($number == 2) ? 2 : ((($number >=
                         3) && ($number <= 10)) ? 3 : ((($number >= 11) &&
                         ($number <= 99)) ? 4 : 5))));
    ...
    public static function setPlural ($rule, $locale)
    {
        ...
        if (! is_callable($rule)) {
            ...
            throw new Zend_Translate_Exception(
                    'The given rule can not be called');
        }
