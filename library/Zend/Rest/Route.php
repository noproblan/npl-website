...
class Zend_Rest_Route extends Zend_Controller_Router_Route_Module
{
    ...
    public function __construct (Zend_Controller_Front $front, 
            array $defaults = array(), array $responders = array())
    {
    ...
    public static function getInstance (Zend_Config $config)
    {
        ...
        $instance = new self($frontController, $defaultsArray, 
                $restfulConfigArray);
        return $instance;
    }
    ...
    public function match ($request, $partial = false)
    {
        ...
        if ($path != '') {
            ...
            } elseif ($this->_checkRestfulController($moduleName, 
                    $controllerName)) {
            ...
            if ($requestMethod != 'get') {
                if ($request->getParam('_method')) {
                    $values[$this->_actionKey] = strtolower(
    ...
    protected function _checkRestfulModule ($moduleName)
    {
        ...
        if ($this->_restfulControllers &&
                 array_key_exists($moduleName, $this->_restfulControllers)) {
            return true;
        }
        return false;
    }
    ...
    protected function _checkRestfulController ($moduleName, $controllerName)
    {
        ...
        if ($this->_checkRestfulModule($moduleName) && $this->_restfulControllers &&
                 (false !==
                 array_search($controllerName, 
                        $this->_restfulControllers[$moduleName]))) {
            return true;
        }
        return false;
    }
