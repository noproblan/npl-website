...
class Zend_Rest_Client extends Zend_Service_Abstract
{
    ...
    private function _prepareRest ($path)
    {
         ...
         * Do this each time
         * because the Zend_Http_Client instance is shared among all
     ...
     * @param array $args
     *            Method args
     * @return Zend_Rest_Client_Result|Zend_Rest_Client Zend_Rest_Client if
     *         using
     *         a remote method, Zend_Rest_Client_Result if using an HTTP request
     *         method
     */
