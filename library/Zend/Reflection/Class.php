...
class Zend_Reflection_Class extends ReflectionClass
{
     ...
     * @throws Zend_Reflection_Exception for missing docblock or invalid
     *         reflection class
     */
            ...
            $reflectionClass = 'Zend_Reflection_Method')
    {
        ...
        $zendReflection = new $reflectionClass($this->getName(), 
            ...
            $reflectionClass = 'Zend_Reflection_Method')
    {
        ...
        $zendReflections = array();
        while ($phpReflections && ($phpReflection = array_shift($phpReflections))) {
            $instance = new $reflectionClass($this->getName(), 
                    $phpReflection->getName());
