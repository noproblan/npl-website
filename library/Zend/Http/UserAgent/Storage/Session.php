...
class Zend_Http_UserAgent_Storage_Session implements Zend_Http_UserAgent_Storage
{
     ...
     * @return void
     * @throws Zend_Http_UserAgent_Storage_Exception on invalid $options
     *         argument
     */
    public function __construct ($options = null)
    {
        ...
        if (null !== $options && ! is_array($options)) {
            ...
            throw new Zend_Http_UserAgent_Storage_Exception(
                    sprintf('Expected array or object options; "%s" provided', 
                            gettype($options)));
        }
        
        // add '.' to prevent the message ''Session namespace must not start
        // with a number'
