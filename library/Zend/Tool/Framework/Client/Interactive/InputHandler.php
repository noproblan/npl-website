...
class Zend_Tool_Framework_Client_Interactive_InputHandler
{
    ...
    public function setClient (
            Zend_Tool_Framework_Client_Interactive_InputInterface $client)
    {
        $this->_client = $client;
        return $this;
    }
    ...
    public function setInputRequest ($inputRequest)
    {
        if (is_string($inputRequest)) {
            ...
            $inputRequest = new Zend_Tool_Framework_Client_Interactive_InputRequest(
                    $inputRequest);
            ...
            throw new Zend_Tool_Framework_Client_Exception(
                    'promptInteractive() requires either a string or an instance of Zend_Tool_Framework_Client_Interactive_InputRequest.');
        }
    ...
    public function handle ()
    {
        ...
        if (is_string($inputResponse)) {
            ...
            $inputResponse = new Zend_Tool_Framework_Client_Interactive_InputResponse(
                    $inputResponse);
        } elseif (! $inputResponse instanceof Zend_Tool_Framework_Client_Interactive_InputResponse) {
            require_once 'Zend/Tool/Framework/Client/Exception.php';
            throw new Zend_Tool_Framework_Client_Exception(
                    'The registered $_interactiveCallback for the client must either return a string or an instance of Zend_Tool_Framework_Client_Interactive_InputResponse.');
        }
