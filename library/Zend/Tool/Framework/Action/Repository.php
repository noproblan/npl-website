 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_Tool_Framework_Action_Repository implements 
        ...
        Countable
{
     ...
     */
    public function addAction (Zend_Tool_Framework_Action_Interface $action, 
            $overrideExistingAction = false)
    {
        ...
        if (! $overrideExistingAction &&
                 array_key_exists(strtolower($actionName), $this->_actions)) {
            require_once 'Zend/Tool/Framework/Action/Exception.php';
            throw new Zend_Tool_Framework_Action_Exception(
    ...
    /**
     * process() - this is called when the client is done constructing (after
     * init())
     *
     * @return unknown
     */
    ...
    /**
     * getIterator() - get all actions, this supports the IteratorAggregate
     * interface
     *
     * @return array
     */
