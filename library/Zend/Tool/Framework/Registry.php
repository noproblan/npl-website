 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_Tool_Framework_Registry implements 
        Zend_Tool_Framework_Registry_Interface
{
    ...
    public function getActionRepository ()
    {
        if ($this->_actionRepository == null) {
            ...
            $this->setActionRepository(
                    new Zend_Tool_Framework_Action_Repository());
        }
    ...
    public function getProviderRepository ()
    {
        if ($this->_providerRepository == null) {
            ...
            $this->setProviderRepository(
                    new Zend_Tool_Framework_Provider_Repository());
        }
    ...
    public function getManifestRepository ()
    {
        if ($this->_manifestRepository == null) {
            ...
            $this->setManifestRepository(
                    new Zend_Tool_Framework_Manifest_Repository());
        }
    ...
    /**
     * isObjectRegistryEnablable() - Check whether an object is registry
     * enablable
     *
     * @param object $object            
     * @return bool
    ...
    public function isObjectRegistryEnablable ($object)
    {
        if (! is_object($object)) {
            require_once 'Zend/Tool/Framework/Registry/Exception.php';
            throw new Zend_Tool_Framework_Registry_Exception(
                    'isObjectRegistryEnablable() expects an object.');
        }
