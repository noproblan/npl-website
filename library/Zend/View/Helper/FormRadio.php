...
class Zend_View_Helper_FormRadio extends Zend_View_Helper_FormElement
{
     ...
     */
    public function formRadio ($name, $value = null, $attribs = null, $options = null, 
            $listsep = "<br />\n")
    {
...
'/[^a-zA-Z0-9\-\_]/'; // No Unicode
        ...
        foreach ($options as $opt_value => $opt_label) {
            ...
            $radio = '<label' . $this->_htmlAttribs($label_attribs) . ' for="' .
                     $optId . '">' .
                     (('prepend' == $labelPlacement) ? $opt_label : '') .
                     '<input type="' . $this->_inputType . '"' . ' name="' .
                     $name . '"' . ' id="' . $optId . '"' . ' value="' .
                     $this->view->escape($opt_value) . '"' . $checked . $disabled .
