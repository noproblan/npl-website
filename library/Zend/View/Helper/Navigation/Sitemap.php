...
class Zend_View_Helper_Navigation_Sitemap extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    public function setServerUrl ($serverUrl)
    {
        ...
        if ($uri->valid()) {
            ...
            $e = new Zend_Uri_Exception(
                    sprintf('Invalid server URL: "%s"', $serverUrl));
            $e->setView($this->view);
            throw $e;
        }
    ...
    public function url (Zend_Navigation_Page $page)
    {
        ...
        if (! isset($href{0})) {
            ...
            $url = $this->getServerUrl() . rtrim($this->view->url(), '/') . '/' .
                     $href;
        }
    ...
    public function getDomSitemap (Zend_Navigation_Container $container = null)
    {
        ...
        foreach ($iterator as $page) {
            ...
            if ($this->getUseSitemapValidators() && ! $locValidator->isValid(
                    $url)) {
            ...
            $urlNode->appendChild(
                    $dom->createElementNS(self::SITEMAP_NS, 'loc', $url));
            ...
            if (isset($page->changefreq)) {
                ...
                if (! $this->getUseSitemapValidators() ||
                    ...
                    $urlNode->appendChild(
                            $dom->createElementNS(self::SITEMAP_NS, 
    ...
    public function render (Zend_Navigation_Container $container = null)
    {
        ...
        $xml = $this->getUseXmlDeclaration() ? $dom->saveXML() : $dom->saveXML(
                $dom->documentElement);
