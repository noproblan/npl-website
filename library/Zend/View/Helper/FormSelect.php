...
class Zend_View_Helper_FormSelect extends Zend_View_Helper_FormElement
{
     ...
     *            array, will mark all values in the array as 'selected' (used
     *            for
     ...
     */
    public function formSelect ($name, $value = null, $attribs = null, $options = null, 
            $listsep = "<br />\n")
    {
        ...
        // force $value to array so we can compare multiple values to multiple
                        // options; also ensure it's a string for comparison
                        // purposes.
        ...
        $xhtml = '<select' . ' name="' . $this->view->escape($name) . '"' .
                 ' id="' . $this->view->escape($id) . '"' . $multiple . $disabled .
        ...
        foreach ((array) $options as $opt_value => $opt_label) {
            if (is_array($opt_label)) {
                ...
                $list[] = '<optgroup' . $opt_disable . $opt_id . ' label="' .
                         $this->view->escape($opt_value) . '">';
