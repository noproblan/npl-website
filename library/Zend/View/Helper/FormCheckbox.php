...
class Zend_View_Helper_FormCheckbox extends Zend_View_Helper_FormElement
{
            ...
            array $checkedOptions = null)
    {
        ...
        $checkedOptions = self::determineCheckboxInfo($value, $checked, 
                $checkedOptions);
        ...
        $xhtml .= '<input type="checkbox"' . ' name="' .
                 $this->view->escape($name) . '"' . ' id="' .
                 $this->view->escape($id) . '"' . ' value="' .
                 $this->view->escape($checkedOptions['checkedValue']) . '"' .
                 $checkedOptions['checkedString'] . $disabled .
     ...
     * @return array
     */
    public static function determineCheckboxInfo ($value, $checked, 
            array $checkedOptions = null)
    {
