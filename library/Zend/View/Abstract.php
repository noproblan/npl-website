...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
    ...
    /**
     * Given a base path, sets the script, helper, and filter paths relative to
     * it
     *
    ...
    public function setPluginLoader (Zend_Loader_PluginLoader $loader, $type)
    {
        ...
        if (! in_array($type, $this->_loaderTypes)) {
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception(
                    sprintf('Invalid plugin loader type "%s"', $type));
            $e->setView($this);
            throw $e;
        }
    ...
    public function getPluginLoader ($type)
    {
        ...
        if (! in_array($type, $this->_loaderTypes)) {
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception(
                    sprintf('Invalid plugin loader type "%s"; cannot retrieve', 
                            $type));
            $e->setView($this);
            throw $e;
        }
    ...
    public function assign ($spec, $value = null)
    {
        ...
        if (is_string($spec)) {
            ...
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception(
                    'assign() expects a string or array, received ' .
                             gettype($spec));
            $e->setView($this);
            throw $e;
        }
     ...
     *
     * Use in conjunction with {@link Zend_View_Helper_DeclareVars the
     * declareVars() helper}
