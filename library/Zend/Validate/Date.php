...
class Zend_Validate_Date extends Zend_Validate_Abstract
{
    ...
    private function _checkFormat ($value)
    {
        try {
            ...
            if (isset($parsed['year']) and ((strpos(strtoupper($this->_format), 
                    'YY') !== false) and
        ...
        if (((strpos($this->_format, 'Y') !== false) or
                 (strpos($this->_format, 'y') !== false)) and
                 (! isset($parsed['year']))) {
            // Year expected but not found
            return false;
        }
        
        if ((strpos($this->_format, 'M') !== false) and
                 (! isset($parsed['month']))) {
        ...
        if (((strpos($this->_format, 'H') !== false) or
                 (strpos($this->_format, 'h') !== false)) and
                 (! isset($parsed['hour']))) {
        ...
        if ((strpos($this->_format, 's') !== false) and
                 (! isset($parsed['second']))) {
