...
class Zend_Validate_File_FilesSize extends Zend_Validate_File_Size
{
     ...
     *
     * Min limits the used diskspace for all files, when used with max=null it
     * is the maximum filesize
     ...
     *
     * Returns true if and only if the disk usage of all files is at least min
     * and
