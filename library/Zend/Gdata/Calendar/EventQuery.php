...
class Zend_Gdata_Calendar_EventQuery extends Zend_Gdata_Query
{
    ...
    {
        if ($value != null) {
            $this->_params['start-max'] = Zend_Gdata_App_Util::formatTimestamp(
                    $value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['start-min'] = Zend_Gdata_App_Util::formatTimestamp(
                    $value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['recurrence-expansion-start'] = Zend_Gdata_App_Util::formatTimestamp(
                    $value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['recurrence-expansion-end'] = Zend_Gdata_App_Util::formatTimestamp(
                    $value);
        } else {
     ...
     *
     * @param string $value
     *            Also accepts bools. If using a string, must be either "true"
     *            or "false".
     * @return Zend_Gdata_Calendar_EventQuery Provides a fluent interface
     */
