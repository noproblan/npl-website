...
class Zend_Gdata_Gapps extends Zend_Gdata
{
    ...
    {
        try {
            return parent::post($data, $uri, $remainingRedirects, $contentType, 
                    $extraHeaders);
        } catch (Zend_Gdata_App_HttpException $e) {
            self::throwServiceExceptionIfDetected($e);
        }
    ...
    {
        try {
            return parent::put($data, $uri, $remainingRedirects, $contentType, 
                    $extraHeaders);
        } catch (Zend_Gdata_App_HttpException $e) {
            self::throwServiceExceptionIfDetected($e);
        }
    ...
    public function insertUser ($user, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($user, $uri, 
    ...
    public function insertNickname ($nickname, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($nickname, $uri, 
    ...
    public function insertGroup ($group, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($group, $uri, 
    ...
    public function insertMember ($member, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($member, $uri, 
    ...
    public function insertOwner ($owner, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($owner, $uri, 
    ...
    public function insertEmailList ($emailList, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($emailList, $uri, 
    ...
    public function insertEmailListRecipient ($recipient, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($recipient, $uri, 
                'Zend_Gdata_Gapps_EmailListRecipientEntry');
        return $newEntry;
    }
    ...
    // Convenience methods
    // Specified at
    // http://code.google.com/apis/apps/gdata_provisioning_api_v2.0_reference.html#appendix_e
     ...
     * @return Zend_Gdata_Gapps_UserEntry (optional) The new user entry as
     *         returned by
     *         server.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
    ...
    {
        return $this->updateEntry($userEntry, 
                $this->getBaseUrl() . self::APPS_USER_PATH . '/' . $username);
    }
     ...
     * @return Zend_Gdata_Gapps_NicknameFeed Collection of
     *         Zend_Gdata_NicknameEntry
    ...
    {
        $this->delete(
                $this->getBaseUrl() . self::APPS_NICKNAME_PATH . '/' . $nickname);
    }
     ...
     * @return Zend_Gdata_Gapps_GroupEntry The group entry as created on the
     *         server.
     */
    public function createGroup ($groupId, $groupName, $description = null, 
     ...
     * @return Zend_Gdata_Gapps_GroupEntry The group entry as returned by the
     *         server.
     */
     ...
     * @return Zend_Gdata_Gapps_MemberEntry The member entry returned by the
     *         server
     */
     ...
     * @param string $emailPermission
     *            The subscription permission of the group
     * @return Zend_Gdata_Gapps_GroupEntry The group entry as updated on the
     *         server.
     */
     ...
     * @return Zend_Gdata_Gapps_EmailListFeed Collection of
     *         Zend_Gdata_EmailListEntry
     *         objects representing all nicknames in the domain.
     * @throws Zend_Gdata_App_Exception
     * @throws Zend_Gdata_App_HttpException
     * @throws Zend_Gdata_Gapps_ServiceException
    ...
    {
        $this->delete(
                $this->getBaseUrl() . self::APPS_EMAIL_LIST_PATH . '/' .
                         $emailList);
    }
