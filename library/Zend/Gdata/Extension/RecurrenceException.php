...
class Zend_Gdata_Extension_RecurrenceException extends Zend_Gdata_Extension
{
     ...
     * @param
     *            Zend_Gdata_EntryLink (optional) An Event entry with details
     *            about the exception.
     * @param
     *            Zend_Gdata_OriginalEvent (optional) The origianl recurrent
     *            event this is an exeption to.
     */
     ...
     * @return Zend_Gdata_Extension_RecurrenceException The element being
     *         modified.
     */
