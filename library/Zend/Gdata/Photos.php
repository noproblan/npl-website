...
class Zend_Gdata_Photos extends Zend_Gdata
{
    ...
    {
        if ($location === null) {
            $uri = self::PICASA_BASE_FEED_URI . '/' . self::DEFAULT_PROJECTION .
    ...
    public function insertAlbumEntry ($album, $uri = null)
    {
        if ($uri === null) {
            $uri = self::PICASA_BASE_FEED_URI . '/' . self::DEFAULT_PROJECTION .
                     '/' . self::USER_PATH . '/' . self::DEFAULT_USER;
        }
        $newEntry = $this->insertEntry($album, $uri, 
    ...
    public function insertPhotoEntry ($photo, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($photo, $uri, 
    ...
    public function insertCommentEntry ($comment, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($comment, $uri, 
