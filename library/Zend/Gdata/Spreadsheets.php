...
class Zend_Gdata_Spreadsheets extends Zend_Gdata
{
     ...
     *
     * @param string $location
     *            A CellQuery, WorksheetEntry or a URI specifying the feed
     *            location.
     * @return CellFeed
     */
     ...
     *
     * @param mixed $location
     *            A ListQuery, WorksheetEntry or string URI specifying the feed
     *            location.
     * @return ListFeed
     */
            ...
            $wkshtId = 'default')
    {
        ...
        $entry->setCell(
                new Zend_Gdata_Spreadsheets_Extension_Cell(null, $row, $col, 
                        $inputValue));
        $response = $entry->save();
        return $response;
    }
     ...
     * @return array An array of rows. Each element of the array is an
     ...
     *
     * @param mixed $location
     *            A CellQuery, WorksheetEntry or a URL (w/o query string)
     *            specifying the feed location.
     * @param string $range
