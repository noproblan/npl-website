...
class Zend_Search_Lucene_Search_QueryToken
{
    ...
    const TT_FIELD = 2; // Field name in 'field:word',
                                       // field:<phrase> or field:(<subquery>)
                                       // pairs
    ...
    const TC_NUMBER = 2; // Nubers, which are used with syntax elements.
                                 // Ex. roam~0.8
                ...
                switch ($tokenText) {
                    ...
                    default:
                        ...
                        throw new Zend_Search_Lucene_Exception(
                                'Unrecognized query syntax lexeme: \'' .
                                         $tokenText . '\'');
                }
                break;
