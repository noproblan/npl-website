...
class Zend_Search_Lucene_Search_BooleanExpressionRecognizer extends Zend_Search_Lucene_FSM
{
     ...
     * array( array( array(<literal>, <is_negative>), // first literal of first
     * conjuction
     * array(<literal>, <is_negative>), // second literal of first conjuction
     * ...
     * array(<literal>, <is_negative>)
     * ), // end of first conjuction
     * array( array(<literal>, <is_negative>), // first literal of second
     * conjuction
    ...
    public function __construct ()
    {
        ...
        $emptyOperatorAction = new Zend_Search_Lucene_FSMAction($this, 
                'emptyOperatorAction');
        $emptyNotOperatorAction = new Zend_Search_Lucene_FSMAction($this, 
        ...
        $notOperatorAction = new Zend_Search_Lucene_FSMAction($this, 
                'notOperatorAction');
        $orOperatorAction = new Zend_Search_Lucene_FSMAction($this, 
                'orOperatorAction');
     ...
     *
     * Operators are defined by class constants: IN_AND_OPERATOR, IN_OR_OPERATOR
     * and IN_NOT_OPERATOR
     *
