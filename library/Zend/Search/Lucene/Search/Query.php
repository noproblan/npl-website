...
abstract class Zend_Search_Lucene_Search_Query
{
     ...
     */
    abstract protected function _highlightMatches (
     ...
     * @return string
     */
    public function highlightMatches ($inputHTML, $defaultEncoding = '', 
            $highlighter = null)
    {
        if ($highlighter === null) {
        ...
        $doc = Zend_Search_Lucene_Document_Html::loadHTML($inputHTML, false, 
                $defaultEncoding);
    ...
    /**
     * Highlight matches in $inputHtmlFragment and return it (without HTML
     * header and body tag)
     *
    ...
    public function htmlFragmentHighlightMatches ($inputHtmlFragment, 
            $encoding = 'UTF-8', $highlighter = null)
    {
        if ($highlighter === null) {
            require_once 'Zend/Search/Lucene/Search/Highlighter/Default.php';
            $highlighter = new Zend_Search_Lucene_Search_Highlighter_Default();
