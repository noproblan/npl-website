    ...
    public function rewrite (Zend_Search_Lucene_Interface $index)
    {
        ...
        foreach ($fields as $field) {
            ...
            if ($this->_lowerTerm !== null) {
                $lowerTerm = new Zend_Search_Lucene_Index_Term(
                        $this->_lowerTerm->text, $field);
            ...
            if ($this->_upperTerm !== null) {
                ...
                $upperTerm = new Zend_Search_Lucene_Index_Term(
                        $this->_upperTerm->text, $field);
                
                while ($index->currentTerm() !== null &&
                         $index->currentTerm()->field == $field &&
                         strcmp($index->currentTerm()->text, $upperTerm->text) <
                         0) {
