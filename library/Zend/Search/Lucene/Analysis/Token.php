...
class Zend_Search_Lucene_Analysis_Token
{
     ...
     *
     * Note:
     * The difference between getEndOffset() and getStartOffset() may not be
     * equal
     * to strlen(Zend_Search_Lucene_Analysis_Token::getTermText()), as the term
     * text may have been altered
