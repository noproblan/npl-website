...
/**
 * User land classes and interfaces turned on by Zend/Search/Analyzer.php file
 * inclusion.
 */
/**
 ...
 * Thus Zend_Search_Lucene analysis API works with data strings and sets
 * (arrays).
 *
 * @category Zend
 * @package Zend_Search_Lucene
...
abstract class Zend_Search_Lucene_Analysis_Analyzer
{
    ...
    public static function setDefault (
            Zend_Search_Lucene_Analysis_Analyzer $analyzer)
    {
