 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_Feed_Writer_Renderer_Feed_Atom extends Zend_Feed_Writer_Renderer_Feed_Atom_AtomAbstract implements 
    ...
    public function render ()
    {
        ...
        foreach ($this->_container as $entry) {
            ...
            if ($entry instanceof Zend_Feed_Writer_Entry) {
                ...
                $renderer = new Zend_Feed_Writer_Renderer_Entry_Atom_Deleted(
                        $entry);
            }
