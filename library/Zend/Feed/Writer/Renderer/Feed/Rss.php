 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_Feed_Writer_Renderer_Feed_Rss extends Zend_Feed_Writer_Renderer_RendererAbstract implements 
        Zend_Feed_Writer_Renderer_RendererInterface
{
    ...
    protected function _setImage (DOMDocument $dom, DOMElement $root)
    {
        ...
        if (isset($image['height'])) {
            if (! ctype_digit((string) $image['height']) ||
                     $image['height'] > 400) {
                require_once 'Zend/Feed/Exception.php';
        ...
        if (isset($image['description'])) {
            if (empty($image['description']) || ! is_string(
                    $image['description'])) {
                require_once 'Zend/Feed/Exception.php';
