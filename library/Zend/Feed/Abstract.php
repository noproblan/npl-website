        ...
        Countable
{
     ...
     *
     * @param string $uri
     *            The full URI of the feed to load, or NULL if not retrieved via
     *            HTTP or as an array.
     * @param string $string
     *            The feed as a string, or NULL if retrieved via HTTP or as an
     *            array.
     * @param Zend_Feed_Builder_Interface $builder
     *            The feed as a builder instance or NULL if retrieved as a
     *            string or via HTTP.
     * @return void
    ...
    {
        return new $this->_entryClassName(null, 
