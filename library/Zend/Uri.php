...
abstract class Zend_Uri
{
     ...
     * only the scheme (http, ftp, etc). Otherwise, supply $uri with the
     * complete URI.
     *
     * @param string $uri
     ...
     * @throws Zend_Uri_Exception When an empty string was supplied for the
     *         scheme
     * @throws Zend_Uri_Exception When an illegal scheme is supplied
     * @throws Zend_Uri_Exception When the scheme is not supported
     * @throws Zend_Uri_Exception When $className doesn't exist or doesn't
     *         implements Zend_Uri
     * @return Zend_Uri
    ...
    public static function factory ($uri = 'http', $className = null)
    {
        ...
        if (strlen($scheme) === 0) {
            ...
            throw new Zend_Uri_Exception(
                    'An empty string was supplied for the scheme');
        }
        
        // Security check: $scheme is used to load a class file, so only
        ...
        if ($className === null) {
             ...
             * scheme, return an instance of that class. Otherwise, a
             * Zend_Uri_Exception is thrown.
             */
            switch ($scheme) {
                case 'http':
        ...
        if (! $schemeHandler instanceof Zend_Uri) {
            require_once 'Zend/Uri/Exception.php';
            throw new Zend_Uri_Exception(
                    "\"$className\" is not an instance of Zend_Uri");
        }
