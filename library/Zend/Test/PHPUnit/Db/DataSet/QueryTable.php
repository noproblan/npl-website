...
/**
 * Represent a PHPUnit Database Extension table with Queries using a Zend_Db
 * adapter for assertion against other tables.
 *
...
class Zend_Test_PHPUnit_Db_DataSet_QueryTable extends PHPUnit_Extensions_Database_DataSet_QueryTable
{
    ...
    {
        if ($this->data === null) {
            $stmt = $this->databaseConnection->getConnection()->query(
                    $this->query);
