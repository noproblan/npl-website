...
/**
 * Uses several query strings or Zend_Db_Select objects to form a dataset of
 * tables for assertion with other datasets.
 *
...
class Zend_Test_PHPUnit_Db_DataSet_QueryDataSet extends PHPUnit_Extensions_Database_DataSet_QueryDataSet
{
    ...
    public function addTable ($tableName, $query = NULL)
    {
        ...
        $this->tables[$tableName] = new Zend_Test_PHPUnit_Db_DataSet_QueryTable(
                $tableName, $query, $this->databaseConnection);
    }
}