...
/**
 * Delete All Operation that can be executed on set up or tear down of a
 * database tester.
 *
 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_Test_PHPUnit_Db_Operation_DeleteAll implements 
        ...
        foreach ($dataSet as $table) {
            try {
                ...
                throw new PHPUnit_Extensions_Database_Operation_Exception(
                        'DELETEALL', 'DELETE FROM ' . $tableName . '', array(), 
                        $table, $e->getMessage());
            }
        }
    }
