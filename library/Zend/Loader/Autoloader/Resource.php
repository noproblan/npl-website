 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_Loader_Autoloader_Resource implements 
        Zend_Loader_Autoloader_Interface
{
     ...
     * @param array $args            
     * @return mixed
     * @throws Zend_Loader_Exception if method not beginning with 'get' or not
     *         matching a valid resource type is called
     */
     ...
     * @param string $path
     *            path relative to resource base path containing the resource
     *            types
     * @param null|string $namespace
     *            sub-component namespace to append to base namespace that
     *            qualifies this resource type
     * @return Zend_Loader_Autoloader_Resource
     */
     ...
     * base path) and optionally the 'namespace' key (indicating the
     * subcomponent
