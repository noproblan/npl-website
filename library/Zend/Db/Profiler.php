...
class Zend_Db_Profiler
{
    ...
    /**
     * Returns the minimum number of seconds for saving query profiles, or null
     * if
    ...
    public function queryStart ($queryText, $queryType = null)
    {
        ...
        $this->_queryProfiles[] = new Zend_Db_Profiler_Query($queryText, 
                $queryType);
     ...
     * If $queryType
     * is set to one of the Zend_Db_Profiler::* constants then only queries of
     * that
     ...
     * queries were found, False is returned. The returned array is indexed by
     * the query
     * profile handles.
     *
     * @param integer $queryType            
     ...
     * one or more of the Zend_Db_Profiler::* constants, the elapsed time will
     * be calculated
     ...
     * be counted. If $queryType is set to one of the Zend_Db_Profiler::*
     * constants, only queries of
