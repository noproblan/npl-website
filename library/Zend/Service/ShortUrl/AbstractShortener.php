 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
abstract class Zend_Service_ShortUrl_AbstractShortener extends Zend_Service_Abstract implements 
        Zend_Service_ShortUrl_Shortener
{
    ...
    protected function _validateUri ($url)
    {
        ...
        if (! Zend_Uri::check($url)) {
            ...
            throw new Zend_Service_ShortUrl_Exception(
                    sprintf('The url "%s" is not valid and cannot be shortened', 
                            $url));
        }
    }
     ...
     *
     * @throws Zend_Service_ShortUrl_Exception If the URL hasn't been shortened
     *         by this service
