...
/**
 * Provides the basic functionality to send a request to the Amazon Ec2 Query
 * API
 *
 * @category Zend
 * @package Zend_Service_Amazon
...
abstract class Zend_Service_Amazon_Ec2_Abstract extends Zend_Service_Amazon_Abstract
{
    ...
    public function __construct ($accessKey = null, $secretKey = null, $region = null)
    {
        if (! $region) {
            ...
            if (! empty($region) &&
                     ! in_array(strtolower($region), self::$_validEc2Regions, 
                            true)) {
    ...
    protected function signParameters (array $paramaters)
    {
        ...
        $hmac = Zend_Crypt_Hmac::compute($this->_getSecretKey(), 'SHA256', 
                $data, Zend_Crypt_Hmac::BINARY);
