...
class Zend_Service_Delicious_Post extends Zend_Service_Delicious_SimplePost
{
    ...
    public function __construct (Zend_Service_Delicious $service, $values)
    {
        ...
        if (! is_array($values) || ! isset($values['url']) ||
            ...
            throw new Zend_Service_Delicious_Exception(
                    "Second argument must be array with at least 2 keys ('url' and" .
                             " 'title')");
        }
        ...
        if (isset($values['date']) && ! $values['date'] instanceof Zend_Date) {
            ...
            require_once 'Zend/Service/Delicious/Exception.php';
            throw new Zend_Service_Delicious_Exception(
                    "Date has to be an instance of Zend_Date");
        }
    ...
    public function save ()
    {
        ...
        return $this->_service->makeRequest(
                Zend_Service_Delicious::PATH_POSTS_ADD, $parms);
    }
