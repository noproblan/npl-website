...
class Zend_Service_StrikeIron_Base
{
    ...
    public function __construct ($options = array())
    {
        if (! extension_loaded('soap')) {
            ...
            throw new Zend_Service_StrikeIron_Exception(
                    'SOAP extension is not enabled');
        }
    ...
    public function __call ($method, $params)
    {
        ...
        try {
            $result = $this->_options['client']->__soapCall($method, $params, 
                    $this->_options['options'], $this->_options['headers'], 
                    $this->_outputHeaders);
        } catch (Exception $e) {
    ...
    protected function _initSoapHeaders ()
    {
        ...
        if (isset($this->_options['headers'])) {
            ...
            foreach ($this->_options['headers'] as $header) {
                if (! $header instanceof SoapHeader) {
                    ...
                    require_once 'Zend/Service/StrikeIron/Exception.php';
                    throw new Zend_Service_StrikeIron_Exception(
                            'Header must be instance of SoapHeader');
                } else 
        ...
        if (! $foundLicenseInfo) {
            $this->_options['headers'][] = new SoapHeader(
                    'http://ws.strikeiron.com', 'LicenseInfo', 
                    array(
    ...
    protected function _transformResult ($result, $method, $params)
    {
        ...
        if (is_object($result)) {
            $result = new Zend_Service_StrikeIron_Decorator($result, 
                    $resultObjectName);
        }
        return $result;
    }
            ...
            $queryMethod = 'GetRemainingHits')
    {
        ...
        if (isset($this->_outputHeaders['SubscriptionInfo'])) {
            ...
            $subscriptionInfo = new Zend_Service_StrikeIron_Decorator($info, 
                    'SubscriptionInfo');
        } else {
