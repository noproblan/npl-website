...
class Zend_Service_DeveloperGarden_VoiceCall extends Zend_Service_DeveloperGarden_Client_ClientAbstract
{
            ...
            $account = null, $privacyA = null, $privacyB = null, $greeter = null)
    {
        ...
        $request->setANumber($aNumber)
            ...
            ->setGreeter($greeter)
            ->setAccount($account);
        $result = $this->getSoapClient()->newCall(
                array(
                        'request' => $request
                ));
     ...
     */
    public function newCallSequenced ($aNumber, $bNumber, $expiration, 
            $maxDuration, $maxWait, $account = null, $privacyA = null, $privacyB = null, 
            $greeter = null)
    {
        ...
        $request->setANumber($aNumber)
            ...
            ->setGreeter($greeter)
            ->setAccount($account);
        $result = $this->getSoapClient()->newCallSequenced(
                array(
                        'request' => $request
                ));
    ...
    public function tearDownCall ($sessionId)
    {
        ...
        $result = $this->getSoapClient()->tearDownCall(
                array(
                        'request' => $request
                ));
    ...
    public function callStatus ($sessionId, $keepAlive = null)
    {
        ...
        $result = $this->getSoapClient()->callStatus2(
                array(
                        'request' => $request
                ));
