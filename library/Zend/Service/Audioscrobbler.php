...
class Zend_Service_Audioscrobbler
{
    ...
    /**
     * Holds error information (e.g., for handling simplexml_load_string()
     * warnings)
     *
     * @var array
     * @access protected
    ...
    /**
     * Sets up character encoding, instantiates the HTTP client, and assigns the
     * web service version.
     */
    ...
    /**
     * Protected method that queries REST service and returns SimpleXML response
     * set
     *
    ...
    protected function _getInfo ($service, $params = null)
    {
        ...
        if ($params === '') {
            $this->getHttpClient()->setUri(
                    "http://ws.audioscrobbler.com{$service}");
        } else {
            $this->getHttpClient()->setUri(
                    "http://ws.audioscrobbler.com{$service}?{$params}");
        }
        ...
        if (preg_match('/No such path/', $responseBody)) {
            ...
            throw new Zend_Http_Client_Exception(
                    'Could not find: ' . $this->_client->getUri());
            ...
            require_once 'Zend/Http/Client/Exception.php';
            throw new Zend_Http_Client_Exception(
                    'The web service ' . $this->_client->getUri() .
        ...
        if (! $simpleXmlElementResponse = simplexml_load_string($responseBody)) {
            ...
            $exception = new Zend_Service_Exception(
                    'Response failed to load with SimpleXML');
    ...
    /**
     * Utility function to get Audioscrobbler profile information (eg: Name,
     * Gender)
     *
    ...
    /**
     * Utility function that returns the user's top tags used most used on a
     * specific artist
     *
     * @return SimpleXMLElement object containing result set
     */
    ...
    /**
     * Utility function that returns a list of people with similar listening
     * preferences to this user
     *
     * @return SimpleXMLElement object containing result set
     */
    ...
    /**
     * Utility function that returns a list of the 10 most recent tracks played
     * by this user
     *
     * @return SimpleXMLElement object containing result set
     */
    ...
    /**
     * Utility function that returns a list of the 10 tracks most recently
     * banned by this user
     *
     * @return SimpleXMLElement object containing result set
     */
    ...
    /**
     * Utility function that returns a list of the 10 tracks most recently loved
     * by this user
     *
     * @return SimpleXMLElement object containing result set
     */
    ...
    /**
     * Utility function that returns a list of dates of available weekly charts
     * for a this user
     *
     * Should actually be named userGetWeeklyChartDateList() but we have to
     * follow audioscrobbler's naming
     *
     * @return SimpleXMLElement object containing result set
     */
    ...
    public function __call ($method, $args)
    {
        if (substr($method, 0, 3) !== "set") {
            ...
            throw new Zend_Service_Exception(
                    "Method " . $method .
                             " does not exist in class Zend_Service_Audioscrobbler.");
        }
