...
/**
 * Zend_Service_Technorati provides an easy, intuitive and object-oriented
 * interface
...
class Zend_Service_Technorati
{
     ...
     *
     * 'type' => (link|weblog)
     * optional - A value of link returns the freshest links referencing your
     * target URL.
     * A value of weblog returns the last set of unique weblogs referencing your
     * target URL.
     * 'limit' => (int)
     ...
     * the portion of Technorati's total result set ranging from start to
     * start+limit.
     ...
     * to the given URL regardless of their current placement on the source
     * blog.
     ...
     * Set this parameter to FALSE to apply no special markup to the blog
     * excerpt.
     * Internally the value is converted in (int).
     *
     * @param string $url
     *            the URL you are searching for. Prefixes http:// and www. are
     *            optional.
     * @param array $options
     *            additional parameters to refine your query
     * @return Zend_Service_Technorati_CosmosResultSet
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/cosmos.html Technorati API:
     ...
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/search.html Technorati API:
     ...
     * 'topexcerptsize' => (int)
     * optional - number of word characters to include in the first post
     * excerpt.
     ...
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/tag.html Technorati API: Tag
     *       Query reference
     */
     ...
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/dailycounts.html Technorati
     *       API: DailyCounts Query reference
     */
     ...
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/toptags.html Technorati API:
     *       TopTags Query reference
     */
    ...
    /**
     * BlogInfo provides information on what blog, if any, is associated with a
     * given URL.
     *
     * @param string $url
     *            the URL you are searching for. Prefixes http:// and www. are
     ...
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/bloginfo.html Technorati API:
     *       BlogInfo Query reference
     */
    ...
    /**
     * BlogPostTags provides information on the top tags used by a specific
     * blog.
     *
     * Query options include:
     *
     ...
     * @return Zend_Service_Technorati_TagsResultSet
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/blogposttags.html Technorati
     *       API: BlogPostTags Query reference
     */
     ...
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/getinfo.html Technorati API:
     *       GetInfo reference
     */
     ...
     * @throws Zend_Service_Technorati_Exception
     * @link http://developers.technorati.com/wiki/KeyInfo Technorati API: Key
     *       Info reference
     */
     ...
     *            Technorati API Key
     * @return void
     * @link http://technorati.com/developers/apikey.html How to get your
     *       Technorati API Key
     */
    ...
    protected function _validateSearch (array $options)
    {
        ...
        $this->_validateInArrayOption('authority', $options, 
                array(
                        'n',
                        'a1',
                        'a4',
     ...
     * @return void
     * @throws Zend_Service_Technorati_Exception
     * @link http://technorati.com/developers/api/error.html Technorati API:
     *       Error response
     * @access protected
     */
     ...
     * @return DOMDocument
     * @throws Zend_Service_Technorati_Exception if response content contains an
     *         error message
     * @access protected
     */
    protected function _convertResponseAndCheckContent (
    ...
    protected static function _checkResponse (Zend_Http_Response $response)
    {
        if ($response->isError()) {
            ...
            require_once 'Zend/Service/Technorati/Exception.php';
            throw new Zend_Service_Technorati_Exception(
                    sprintf('Invalid response status code (HTTP/%s %s %s)', 
                            $response->getVersion(), $response->getStatus(), 
                            $response->getMessage()));
        }
    }
