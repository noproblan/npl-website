 ...
 * @property string $PopReceipt Receipt verification for deleting the message
 *           from queue.
 * @property string $TimeNextVisible Next time the message is visible in the
 *           queue
 * @property int $DequeueCount Number of times the message has been dequeued.
 *           This value is incremented each time the message is subsequently
 *           dequeued.
...
class Zend_Service_WindowsAzure_Storage_QueueMessage extends Zend_Service_WindowsAzure_Storage_StorageEntityAbstract
{
     ...
     *            Number of times the message has been dequeued. This value is
     *            incremented each time the message is subsequently dequeued.
     * @param string $messageText
     *            Message text
     */
    public function __construct ($messageId, $insertionTime, $expirationTime, 
            $popReceipt, $timeNextVisible, $dequeueCount, $messageText)
    {
        $this->_data = array(
                'messageid' => $messageId,
