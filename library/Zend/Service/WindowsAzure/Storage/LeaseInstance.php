 ...
 * @property string $LeaseTime Time remaining in the lease period, in seconds.
 *           This header is returned only for a successful request to break the
 *           lease. It provides an approximation as to when the lease period
 *           will expire.
 */
class Zend_Service_WindowsAzure_Storage_LeaseInstance extends Zend_Service_WindowsAzure_Storage_StorageEntityAbstract
{
     ...
     *            Time remaining in the lease period, in seconds. This header is
     *            returned only for a successful request to break the lease. It
     *            provides an approximation as to when the lease period will
     *            expire.
     */
