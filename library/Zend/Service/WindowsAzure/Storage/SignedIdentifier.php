 ...
 * @property string $Start The time at which the Shared Access Signature becomes
 *           valid.
 * @property string $Expiry The time at which the Shared Access Signature
 *           becomes invalid.
 * @property string $Permissions Signed permissions - read (r), write (w),
 *           delete (d) and list (l)
 */
class Zend_Service_WindowsAzure_Storage_SignedIdentifier extends Zend_Service_WindowsAzure_Storage_StorageEntityAbstract
{
     ...
     *            (l)
     */
    public function __construct ($id = '', $start = '', $expiry = '', 
            $permissions = '')
    {
        $this->_data = array(
                'id' => $id,
