...
abstract class Zend_Service_WindowsAzure_Credentials_CredentialsAbstract
{
    ...
    /**
     * Creates a new Zend_Service_WindowsAzure_Credentials_CredentialsAbstract
     * instance
     *
    ...
    public function setAccountName (
            $value = Zend_Service_WindowsAzure_Credentials_CredentialsAbstract::DEVSTORE_ACCOUNT)
    {
    ...
    public function setAccountkey (
            $value = Zend_Service_WindowsAzure_Credentials_CredentialsAbstract::DEVSTORE_KEY)
    {
    ...
    abstract public function signRequestHeaders (
            $httpVerb = Zend_Http_Client::GET, $path = '/', $queryString = '', $headers = null, 
    ...
    /**
     * Returns an array value if the key is set, otherwide returns
     * $valueIfNotSet
     *
     * @param array $array            
     * @param mixed $key            
