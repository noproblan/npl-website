...
class Zend_Service_WindowsAzure_SessionHandler
{
    ...
    public function __construct (
            Zend_Service_WindowsAzure_Storage_Table $tableStorage, 
            $sessionTable = 'phpsessions', $sessionTablePartition = 'sessions')
    {
        // Set properties
    ...
    {
        $sessionRecord = new Zend_Service_WindowsAzure_Storage_DynamicTableEntity(
                $this->_sessionTablePartition, $id);
        ...
        try {
            $this->_tableStorage->updateEntity($this->_sessionTable, 
                    $sessionRecord);
        } catch (Zend_Service_WindowsAzure_Exception $unknownRecord) {
            $this->_tableStorage->insertEntity($this->_sessionTable, 
                    $sessionRecord);
        }
    }
    ...
    public function destroy ($id)
    {
        try {
            $sessionRecord = $this->_tableStorage->retrieveEntityById(
                    $this->_sessionTable, $this->_sessionTablePartition, $id);
            $this->_tableStorage->deleteEntity($this->_sessionTable, 
                    $sessionRecord);
    ...
    {
        try {
            $result = $this->_tableStorage->retrieveEntities(
                    $this->_sessionTable, 
