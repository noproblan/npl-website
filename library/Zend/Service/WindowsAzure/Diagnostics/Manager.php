...
class Zend_Service_WindowsAzure_Diagnostics_Manager
{
    ...
    public function __construct (
            Zend_Service_WindowsAzure_Storage_Blob $blobStorageClient = null, 
    ...
    {
        if (! $this->_blobStorageClient->containerExists(
     ...
     *            Role instance name, can be found in $_SERVER['RdRoleId'] when
    ...
    public function configurationForRoleInstanceExists ($roleInstance = null)
    {
        if ($roleInstance === null) {
            throw new Zend_Service_WindowsAzure_Diagnostics_Exception(
                    'Role instance should be specified. Try reading $_SERVER[\'RdRoleId\'] for this information if the application is hosted on Windows Azure Fabric or Development Fabric.');
        }
        
        return $this->_blobStorageClient->blobExists($this->_controlContainer, 
                $roleInstance);
    }
    ...
    public function configurationForCurrentRoleInstanceExists ()
    {
        if (! isset($_SERVER['RdRoleId'])) {
            throw new Zend_Service_WindowsAzure_Diagnostics_Exception(
                    'Server variable \'RdRoleId\' is unknown. Please verify the application is running in Development Fabric or Windows Azure Fabric.');
        }
     ...
     * @throws Zend_Service_WindowsAzure_Diagnostics_Exception
     */
    public function setConfigurationForCurrentRoleInstance (
            Zend_Service_WindowsAzure_Diagnostics_ConfigurationInstance $configuration)
    {
        ...
        $this->setConfigurationForRoleInstance($_SERVER['RdRoleId'], 
                $configuration);
    }
    ...
    public function getConfigurationForRoleInstance ($roleInstance = null)
    {
        ...
        if ($this->_blobStorageClient->blobExists($this->_controlContainer, 
                $roleInstance)) {
            $configurationInstance = new Zend_Service_WindowsAzure_Diagnostics_ConfigurationInstance();
            $configurationInstance->loadXml(
                    $this->_blobStorageClient->getBlobData(
                            $this->_controlContainer, $roleInstance));
     ...
     * @throws Zend_Service_WindowsAzure_Diagnostics_Exception
     */
    public function setConfigurationForRoleInstance ($roleInstance = null, 
            Zend_Service_WindowsAzure_Diagnostics_ConfigurationInstance $configuration)
    {
        if ($roleInstance === null) {
            throw new Zend_Service_WindowsAzure_Diagnostics_Exception(
        ...
        $this->_blobStorageClient->putBlobData($this->_controlContainer, 
                $roleInstance, $configuration->toXml(), array(), null, 
                array(
