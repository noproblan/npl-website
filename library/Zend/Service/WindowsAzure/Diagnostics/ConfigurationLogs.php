 ...
 * @property int ScheduledTransferPeriodInMinutes Scheduled transfer period in
 *           minutes
 * @property string ScheduledTransferLogLevelFilter Scheduled transfer log level
 *           filter
 */
class Zend_Service_WindowsAzure_Diagnostics_ConfigurationLogs extends Zend_Service_WindowsAzure_Diagnostics_ConfigurationObjectBaseAbstract
{
     ...
     *            log level filter
     */
    public function __construct ($bufferQuotaInMB = 0, 
            $scheduledTransferPeriodInMinutes = 0, 
            $scheduledTransferLogLevelFilter = Zend_Service_WindowsAzure_Diagnostics_LogLevel::UNDEFINED)
    {
        $this->_data = array(
