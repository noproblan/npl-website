...
class Zend_Service_SlideShare
{
     ...
     * If no cache object
     * was previously set the the default will be used (Filesystem caching in
     * /tmp with a life
     ...
     *            The password
     */
    public function __construct ($apikey, $sharedSecret, $username = null, 
            $password = null)
    {
     ...
     *            Determines if the the slide show's source file is public or
     *            not upon upload
     * @return Zend_Service_SlideShare_SlideShow The passed Slide show object,
     *         with the new assigned ID provided
     */
    public function uploadSlideShow (Zend_Service_SlideShare_SlideShow $ss, 
    ...
    public function getSlideShow ($ss_id)
    {
        ...
        if (! $retval = $cache->load($cache_key)) {
            ...
            if ($sxe->getName() == "SlideShareServiceError") {
                ...
                list ($code, $error_str) = explode(':', $message);
                require_once 'Zend/Service/SlideShare/Exception.php';
                throw new Zend_Service_SlideShare_Exception(trim($error_str), 
                        $code);
            }
     ...
     */
    public function getSlideShowsByUsername ($username, $offset = null, 
            $limit = null)
    {
        return $this->_getSlideShowsByType('username_for', $username, $offset, 
                $limit);
    }
    ...
    {
        return $this->_getSlideShowsByType('group_name', $group, $offset, 
                $limit);
    }

    /**
     * Retrieves Zend_Service_SlideShare_SlideShow object arrays based on the
     * type of
     * list desired
     *
     * @param string $key
     ...
     * @return array An array of Zend_Service_SlideShare_SlideShow objects
     */
    protected function _getSlideShowsByType ($key, $value, $offset = null, 
            $limit = null)
    {
        $key = strtolower($key);
    ...
    /**
     * Converts a SimpleXMLElement object representing a response from the
     * service
