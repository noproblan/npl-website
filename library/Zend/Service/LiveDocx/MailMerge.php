...
class Zend_Service_LiveDocx_MailMerge extends Zend_Service_LiveDocx
{
    ...
    public function setFieldValues ($values)
    {
        ...
        try {
            ...
            require_once 'Zend/Service/LiveDocx/Exception.php';
            throw new Zend_Service_LiveDocx_Exception('Cannot set field values', 
                    0, $e);
        }
    ...
    public function setBlockFieldValues ($blockName, $blockFieldValues)
    {
        ...
        try {
            $this->getSoapClient()->SetBlockFieldValues(
                    array(
                            'blockName' => $blockName,
                            'blockFieldValues' => self::multiAssocArrayToArrayOfArrayOfString(
                                    $blockFieldValues)
                    ));
        } catch (Exception $e) {
            require_once 'Zend/Service/LiveDocx/Exception.php';
    ...
    public function createDocument ()
    {
        ...
        try {
            ...
            require_once 'Zend/Service/LiveDocx/Exception.php';
            throw new Zend_Service_LiveDocx_Exception('Cannot create document', 
                    0, $e);
        }
    }
    ...
    public function getMetafiles ($fromPage, $toPage)
    {
        ...
        if (isset($result->GetMetafilesResult->string)) {
            ...
            if (is_array($result->GetMetafilesResult->string)) {
                ...
                $ret[$pageCounter] = base64_decode(
                        $result->GetMetafilesResult->string);
            }
        }
    ...
    public function getAllMetafiles ()
    {
        ...
        if (isset($result->GetAllMetafilesResult->string)) {
            ...
            if (is_array($result->GetAllMetafilesResult->string)) {
                ...
                $ret[$pageCounter] = base64_decode(
                        $result->GetAllMetafilesResult->string);
            }
        }
    ...
    public function getBitmaps ($fromPage, $toPage, $zoomFactor, $format)
    {
        ...
        if (isset($result->GetBitmapsResult->string)) {
            ...
            if (is_array($result->GetBitmapsResult->string)) {
                ...
                $ret[$pageCounter] = base64_decode(
                        $result->GetBitmapsResult->string);
            }
        }
    ...
    public function getAllBitmaps ($zoomFactor, $format)
    {
        ...
        if (isset($result->GetAllBitmapsResult->string)) {
            ...
            if (is_array($result->GetAllBitmapsResult->string)) {
                ...
                $ret[$pageCounter] = base64_decode(
                        $result->GetAllBitmapsResult->string);
            }
        }
    ...
    public function uploadTemplate ($filename)
    {
        ...
        try {
            ...
            require_once 'Zend/Service/LiveDocx/Exception.php';
            throw new Zend_Service_LiveDocx_Exception('Cannot upload template', 
                    0, $e);
        }
    }
    ...
    public function downloadTemplate ($filename)
    {
        ...
        try {
            ...
            require_once 'Zend/Service/LiveDocx/Exception.php';
            throw new Zend_Service_LiveDocx_Exception('Cannot download template', 
                    0, $e);
        }
    ...
    public function uploadImage ($filename)
    {
        ...
        try {
            ...
            require_once 'Zend/Service/LiveDocx/Exception.php';
            throw new Zend_Service_LiveDocx_Exception('Cannot upload image', 0, 
                    $e);
        }
    }
    ...
    public function downloadImage ($filename)
    {
        ...
        try {
            ...
            require_once 'Zend/Service/LiveDocx/Exception.php';
            throw new Zend_Service_LiveDocx_Exception('Cannot download image', 0, 
                    $e);
        }
    ...
    /**
     * Convert LiveDocx service return value from list methods to consistent PHP
     * array
     *
     * @param array $list            
     * @return array
            ...
            foreach ($list->ArrayOfString as $a) {
                ...
                if (isset($o->string)) {
                    ...
                    $ret[] = array(
                            ...
                            'createTime' => (integer) $date1->get(
                                    Zend_Date::TIMESTAMP),
                            'modifyTime' => (integer) $date2->get(
                                    Zend_Date::TIMESTAMP)
                    );
                }
            }
