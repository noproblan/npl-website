...
class Zend_Service_Ebay_Finding_Response_Items extends Zend_Service_Ebay_Finding_Response_Histograms
{
    ...
    protected function _init ()
    {
        ...
        $this->_attributes['searchResult'] = array(
                'count' => $this->_query(".//$ns:searchResult[1]/@count[1]", 
                        'string')
        );
        
        $node = $this->_xPath->query(".//$ns:searchResult[1]", $this->_dom)->item(
                0);
        if ($node) {
            /**
             *
            ...
            $this->searchResult = new Zend_Service_Ebay_Finding_Search_Result(
                    $node);
        }
        
        $node = $this->_xPath->query(".//$ns:paginationOutput[1]", $this->_dom)->item(
                0);
        if ($node) {
            /**
             *
            ...
            $this->paginationOutput = new Zend_Service_Ebay_Finding_PaginationOutput(
                    $node);
        }
    }
     ...
     * @return Zend_Service_Ebay_Finding_Response_Items
     */
    public function pageLast (Zend_Service_Ebay_Finding $proxy, 
     ...
     * @return Zend_Service_Ebay_Finding_Response_Items
     */
    public function pageNext (Zend_Service_Ebay_Finding $proxy, 
            $max = self::PAGE_MAX_DEFAULT)
    {
