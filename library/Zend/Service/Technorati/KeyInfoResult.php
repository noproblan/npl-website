...
class Zend_Service_Technorati_KeyInfoResult
{
    ...
    public function __construct (DomDocument $dom, $apiKey = null)
    {
        ...
        $this->_apiQueries = (int) $xpath->query(
                '/tapi/document/result/apiqueries/text()')->item(0)->data;
        $this->_maxQueries = (int) $xpath->query(
                '/tapi/document/result/maxqueries/text()')->item(0)->data;
