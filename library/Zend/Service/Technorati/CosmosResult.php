...
class Zend_Service_Technorati_CosmosResult extends Zend_Service_Technorati_Result
{
    ...
    public function __construct (DomElement $dom)
    {
        ...
        // filter fields
        $this->_nearestPermalink = Zend_Service_Technorati_Utils::normalizeUriHttp(
                $this->_nearestPermalink);
        $this->_linkUrl = Zend_Service_Technorati_Utils::normalizeUriHttp(
                $this->_linkUrl);
        $this->_linkCreated = Zend_Service_Technorati_Utils::normalizeDate(
                $this->_linkCreated);
    }
