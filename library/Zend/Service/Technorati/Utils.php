...
class Zend_Service_Technorati_Utils
{
    ...
    public static function normalizeUriHttp ($input)
    {
        ...
        if ($input instanceof Zend_Uri_Http) {
            ...
            try {
                ...
                throw new Zend_Service_Technorati_Exception($e->getMessage(), 0, 
                        $e);
            }
        }
    ...
    public static function normalizeDate ($input)
    {
        ...
        // due to a BC break as of ZF 1.5 it's not safe to use
        // Zend_Date::isDate() here
        // see ZF-2524, ZF-2334
        if (@strtotime($input) !== FALSE) {
            ...
            require_once 'Zend/Service/Technorati/Exception.php';
            throw new Zend_Service_Technorati_Exception(
                    "'$input' is not a valid Date/Time");
        }
    }
