        ...
        Zend_Cache_Backend_ExtendedInterface
{
     ...
     * - The automatic vacuum process defragment the database file (and make it
     * smaller)
     * when a clean() or delete() is called
     * 0 => no automatic vacuum
     * 1 => systematic vacuum (when delete() or clean() methods are called)
     * x (integer) > 1 => automatic vacuum randomly 1 times on x clean() or
     * delete()
     *
    ...
    /**
     * Check if the database structure is ok (with the good version), if no :
     * build it
     *
     * @throws Zend_Cache_Exception
     * @return boolean True if ok
