...
class Zend_Cache_Manager
{
    ...
    public function getCache ($name)
    {
        ...
        if (isset($this->_optionTemplates[$name])) {
            if ($name == self::PAGECACHE &&
                ...
                $this->_optionTemplates[$name]['backend']['options']['tag_cache'] = $this->getCache(
                        self::PAGETAGCACHE);
            }
            ...
            $this->_caches[$name] = Zend_Cache::factory(
                    ...
                    isset(
                            $this->_optionTemplates[$name]['frontend']['customFrontendNaming']) ? $this->_optionTemplates[$name]['frontend']['customFrontendNaming'] : false, 
                    isset(
     ...
     * @param array $options            
     * @return Zend_Cache_Manager
     * @throws Zend_Cache_Exception for invalid options format or if option
    ...
    public function setTemplateOptions ($name, $options)
    {
        ...
        $this->_optionTemplates[$name] = $this->_mergeOptions(
                $this->_optionTemplates[$name], $options);
        return $this;
    }
