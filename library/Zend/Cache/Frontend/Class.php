...
class Zend_Cache_Frontend_Class extends Zend_Cache_Core
{
     ...
     * - an array of method names which will be cached (even if cache_by_default
     * = false)
     *
     * ====> (array) non_cached_methods :
     * - an array of method names which won't be cached (even if
     ...
     *
     * if set to a class name, we will cache an abstract class and will use only
     * static calls
     * if set to an object, we will cache this object methods
     *
    ...
    {
        return md5(
                $this->_cachedEntityLabel . '__' . $name . '__' .
                         serialize($args));
    }
}
