...
class Zend_InfoCard_Cipher
{
    ...
    /**
     * Returns an instance of a cipher object supported based on the URI
     * provided
     *
     * @throws Zend_InfoCard_Cipher_Exception
     * @param string $uri
     *            The URI of the encryption method wantde
     * @return mixed an Instance of Zend_InfoCard_Cipher_Symmetric_Interface or
    ...
    static public function getInstanceByURI ($uri)
    {
        switch ($uri) {
            ...
            case self::ENC_RSA_OAEP_MGF1P:
                ...
                return new Zend_InfoCard_Cipher_Pki_Adapter_Rsa(
                        Zend_InfoCard_Cipher_Pki_Adapter_Rsa::OAEP_PADDING);
                break;
            
            case self::ENC_RSA:
                include_once 'Zend/InfoCard/Cipher/Pki/Adapter/Rsa.php';
                return new Zend_InfoCard_Cipher_Pki_Adapter_Rsa(
                        Zend_InfoCard_Cipher_Pki_Adapter_Rsa::NO_PADDING);
                break;
