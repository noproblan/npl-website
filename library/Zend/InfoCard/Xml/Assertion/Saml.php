 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_InfoCard_Xml_Assertion_Saml extends Zend_InfoCard_Xml_Element implements 
        Zend_InfoCard_Xml_Assertion_Interface
{
    ...
    /**
     * The amount of time in seconds to buffer when checking conditions to
     * ensure
     ...
     *            An array of condtions for the assertion taken from
     *            getConditions()
     * @return mixed Boolean true on success, an array of condition, error
     *         message on failure
     */
     ...
     *
     * @return integer a UNIX timestamp representing when the assertion was
     *         issued
     */
