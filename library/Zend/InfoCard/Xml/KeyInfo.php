...
class Zend_InfoCard_Xml_KeyInfo
{
    ...
    /**
     * Returns an instance of KeyInfo object based on the input KeyInfo XML
     * block
     *
            ...
            foreach ($sxe->getDocNameSpaces() as $namespace) {
                switch ($namespace) {
                    ...
                    default:
                        ...
                        throw new Zend_InfoCard_Xml_Exception(
                                "Unknown KeyInfo Namespace provided");
                    // We are ignoring these lines, as XDebug reports each as a
                // "non executed" line
