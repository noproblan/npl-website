...
/**
 * A class to create a transform rule set based on XML URIs and then apply those
 * rules
...
class Zend_InfoCard_Xml_Security_Transform
{
    ...
    public function applyTransforms ($strXmlDocument)
    {
        foreach ($this->_transformList as $transform) {
            ...
            // We can't really test this check because it would require logic
            // changes in the component itself
