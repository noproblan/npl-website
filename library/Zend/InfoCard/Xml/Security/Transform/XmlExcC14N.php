 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class Zend_InfoCard_Xml_Security_Transform_XmlExcC14N implements 
        Zend_InfoCard_Xml_Security_Transform_Interface
{

    /**
     * Transform the input XML based on C14n XML Exclusive Canonicalization
     * rules
     *
    ...
    public function transform ($strXMLData)
    {
        ...
        throw new Zend_InfoCard_Xml_Security_Transform_Exception(
                "This transform requires the C14N() method to exist in the DOM extension");
    }
}
