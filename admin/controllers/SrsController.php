...
class SrsController extends Zend_Controller_Action
{
	...
	public function editAction()
	{
		...
		$this->view->map = new Application_Model_Map(array("name" => "new", "lanId" => 0));
	...
	public function ajaxsaveAction()
	{
		...
		$mapsMapper = new Application_Model_Mapper_MapsMapper();
		$mapModel = new Application_Model_Map(array(
			"color" => "000000", "height" => 1000, "width" => 2000
		));
		...
		foreach($desksToSave as $deskToSave) {
			$desk = new Application_Model_Desk(array(
				"deskTypeId" => 1,
				"height" => 80,
				"width" => 180,
				"active" => 1
			...
			if ($deskToSave["seats"]["leftseat"] == "true") {
				...
				$newSeat = new Application_Model_Seat(array(
					"active" => true,
					"deskId" => $desk->getId(),
					"seatPositionId" => 1,
					"name" => $desk->getId()
