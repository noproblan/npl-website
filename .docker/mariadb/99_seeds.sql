...
-- PW = banane.SALT
--
INSERT INTO `npl`.`npl_users` (`id`, `username`, `password`, `salt`, `mail`, `active`, `mail_verified`, `register_datetime`, `written_datetime`) VALUES
...
(3, 'dev-user', SHA1(CONCAT('banane', SHA1('banane'))), SHA1('banane'), 'dev-user@noproblan.ch', 1, 1, '2012-01-01 00:00:00', '2012-01-01 00:00:00');
...
INSERT INTO `npl`.`npl_userroles` (`id`, `user_id`, `role_id`, `written_datetime`) VALUES
...
--
INSERT INTO `npl`.`npl_admin_resources` (`id`, `controller_name`, `action_name`, `written_datetime`) VALUES
...
(17, 'helper', 'index', '2013-04-04 13:02:22');

--
-- Dumping data for table `npl_admin_rights`
--
INSERT INTO `npl`.`npl_admin_rights` (`id`, `admin_role_id`, `admin_resource_id`, `written_datetime`) VALUES
...
(27, 6, 17, '2013-04-04 13:02:41');

--
-- Dumping data for table `npl_admin_roles`
--
INSERT INTO `npl`.`npl_admin_roles` (`id`, `name`, `written_datetime`) VALUES
...
(6, 'Helfer', '2013-02-04 21:24:17');

--
-- Dumping data for table `npl_admin_userroles`
--
INSERT INTO `npl`.`npl_admin_userroles` (`id`, `user_id`, `role_id`, `written_datetime`) VALUES
...
(6, 3, 6, '2012-09-07 00:00:00');

--
-- Dumping data for table `npl_gal_albums`
--
INSERT INTO `npl`.`npl_gal_albums` (`id`, `name`, `folder`, `written_datetime`) VALUES
...
--
INSERT INTO `npl`.`npl_lans` (`id`, `name`, `start_datetime`, `end_datetime`, `registration_end_datetime`, `planned_seats`, `written_datetime`) VALUES
...
--
INSERT INTO `npl`.`npl_laninfos` (`id`, `lan_id`, `name`, `info`, `order`, `written_datetime`) VALUES
...
INSERT INTO `npl`.`npl_resources` (`id`, `controller_name`, `action_name`, `written_datetime`) VALUES
(1, 'error', '', '2011-12-31 23:00:00'),
(2, 'index', 'index', '2011-12-31 23:00:00'),
(3, 'index', 'about', '2011-12-31 23:00:00'),
(4, 'index', 'contact', '2011-12-31 23:00:00'),
(5, 'auth', 'index', '2011-12-31 23:00:00'),
(6, 'auth', 'login', '2011-12-31 23:00:00'),
(7, 'auth', 'logout', '2011-12-31 23:00:00'),
(8, 'user', 'index', '2011-12-31 23:00:00'),
(9, 'user', 'verify', '2011-12-31 23:00:00'),
(10, 'user', 'register', '2011-12-31 23:00:00'),
(11, 'user', 'activate', '2011-12-31 23:00:00'),
(12, 'user', 'forgotpassword', '2011-12-31 23:00:00'),
(13, 'user', 'forgotusername', '2011-12-31 23:00:00'),
(14, 'user', 'resendactivation', '2011-12-31 23:00:00'),
(15, 'user', 'resetpassword', '2011-12-31 23:00:00'),
(16, 'user', 'profile', '2011-12-31 23:00:00'),
(17, 'user', 'changepassword', '2011-12-31 23:00:00'),
(18, 'user', 'changemail', '2011-12-31 23:00:00'),
(19, 'user', 'resendverification', '2011-12-31 23:00:00'),
(20, 'user', 'delete', '2011-12-31 23:00:00'),
(21, 'gallery', 'index', '2011-12-31 23:00:00'),
(22, 'gallery', 'list', '2011-12-31 23:00:00'),
(23, 'gallery', 'album', '2011-12-31 23:00:00'),
(24, 'lan', 'index', '2011-12-31 23:00:00'),
(25, 'lan', 'list', '2011-12-31 23:00:00'),
(26, 'lan', 'info', '2011-12-31 23:00:00'),
(27, 'lan', 'participate', '2011-12-31 23:00:00'),
(28, 'user', 'migrate', '2011-12-31 23:00:00'),
(29, 'user', 'account', '2012-09-08 14:11:10'),
(30, 'ticket', 'changeextras', '2012-09-08 14:11:10'),
(31, 'sponsor', 'index', '2012-09-30 16:24:09'),
(32, 'sponsor', 'list', '2012-09-30 16:24:09'),
(33, 'ticket', 'reserveseat', '2012-09-30 16:24:09'),
(34, 'lan', 'reservation', '2012-09-30 16:24:09'),
(35, 'news', 'index', '2014-12-20 10:28:47'),
(36, 'news', 'list', '2014-12-20 10:28:47'),
(37, 'ticket', 'showpayment', '2015-01-08 16:51:39'),
(38, 'index', 'sitemap', '2016-10-25 15:12:33'),
(39, 'user', 'newslettermailer', '2022-03-24 19:50:24');
...
INSERT INTO `npl`.`npl_roles` (`id`, `name`, `written_datetime`) VALUES
...
INSERT INTO `npl`.`npl_rights` (`id`, `role_id`, `resource_id`, `written_datetime`) VALUES
(1, 2, 2, '2011-12-31 23:00:00'),
(2, 2, 3, '2011-12-31 23:00:00'),
(3, 2, 4, '2011-12-31 23:00:00'),
(4, 3, 2, '2011-12-31 23:00:00'),
(5, 3, 3, '2011-12-31 23:00:00'),
(6, 3, 4, '2011-12-31 23:00:00'),
(7, 2, 5, '2011-12-31 23:00:00'),
(8, 2, 6, '2011-12-31 23:00:00'),
(9, 3, 5, '2011-12-31 23:00:00'),
(10, 3, 7, '2011-12-31 23:00:00'),
(11, 2, 8, '2011-12-31 23:00:00'),
(12, 2, 9, '2011-12-31 23:00:00'),
(13, 2, 10, '2011-12-31 23:00:00'),
(14, 2, 11, '2011-12-31 23:00:00'),
(15, 2, 12, '2011-12-31 23:00:00'),
(16, 2, 13, '2011-12-31 23:00:00'),
(17, 2, 14, '2011-12-31 23:00:00'),
(18, 2, 15, '2011-12-31 23:00:00'),
(19, 3, 8, '2011-12-31 23:00:00'),
(20, 3, 9, '2011-12-31 23:00:00'),
(21, 3, 16, '2012-08-15 15:33:34'),
(22, 3, 17, '2012-08-15 15:33:35'),
(23, 3, 18, '2012-08-15 15:33:35'),
(24, 3, 19, '2011-12-31 23:00:00'),
(25, 3, 20, '2011-12-31 23:00:00'),
(26, 2, 21, '2011-12-31 23:00:00'),
(27, 2, 22, '2011-12-31 23:00:00'),
(29, 2, 23, '2011-12-31 23:00:00'),
(30, 3, 21, '2011-12-31 23:00:00'),
(31, 3, 22, '2011-12-31 23:00:00'),
(32, 3, 23, '2011-12-31 23:00:00'),
(33, 2, 24, '2011-12-31 23:00:00'),
(34, 2, 25, '2011-12-31 23:00:00'),
(35, 2, 26, '2011-12-31 23:00:00'),
(37, 3, 24, '2011-12-31 23:00:00'),
(38, 3, 25, '2011-12-31 23:00:00'),
(39, 3, 26, '2011-12-31 23:00:00'),
(40, 3, 27, '2011-12-31 23:00:00'),
(41, 2, 28, '2011-12-31 23:00:00'),
(42, 3, 29, '2012-09-08 14:11:10'),
(43, 2, 16, '2012-09-08 14:11:10'),
(44, 3, 6, '2012-09-08 14:11:10'),
(45, 3, 30, '2012-09-08 14:11:10'),
(46, 2, 31, '2012-09-30 16:24:09'),
(47, 2, 32, '2012-09-30 16:24:09'),
(48, 3, 31, '2012-09-30 16:24:09'),
(49, 3, 32, '2012-09-30 16:24:09'),
(50, 4, 2, '2012-09-24 22:00:00'),
(51, 4, 3, '2012-09-24 22:00:00'),
(52, 4, 4, '2012-09-24 22:00:00'),
(53, 4, 5, '2012-09-24 22:00:00'),
(54, 4, 6, '2012-09-24 22:00:00'),
(55, 4, 7, '2012-09-24 22:00:00'),
(56, 4, 8, '2012-09-24 22:00:00'),
(57, 4, 9, '2012-09-24 22:00:00'),
(58, 4, 16, '2012-09-24 22:00:00'),
(59, 4, 17, '2012-09-24 22:00:00'),
(60, 4, 18, '2012-09-24 22:00:00'),
(61, 4, 19, '2012-09-24 22:00:00'),
(62, 4, 20, '2012-09-24 22:00:00'),
(63, 4, 21, '2012-09-24 22:00:00'),
(64, 4, 22, '2012-09-24 22:00:00'),
(65, 4, 23, '2012-09-24 22:00:00'),
(66, 4, 24, '2012-09-24 22:00:00'),
(67, 4, 25, '2012-09-24 22:00:00'),
(68, 4, 26, '2012-09-24 22:00:00'),
(69, 4, 27, '2012-09-24 22:00:00'),
(70, 4, 29, '2012-09-24 22:00:00'),
(71, 4, 30, '2012-09-24 22:00:00'),
(72, 4, 31, '2012-09-24 22:00:00'),
(73, 4, 32, '2012-09-24 22:00:00'),
(81, 3, 33, '2012-09-30 16:24:09'),
(82, 3, 34, '2012-09-30 16:24:09'),
(83, 2, 35, '2014-12-20 10:30:16'),
(84, 3, 35, '2014-12-20 10:30:16'),
(85, 4, 35, '2014-12-20 10:30:30'),
(86, 2, 36, '2014-12-20 10:30:30'),
(87, 3, 36, '2014-12-20 10:30:40'),
(88, 4, 36, '2014-12-20 10:30:40'),
(89, 3, 37, '2015-01-08 16:51:51'),
(90, 4, 37, '2015-01-08 16:51:55'),
(91, 2, 38, '2016-10-25 15:13:16'),
(92, 3, 38, '2016-10-25 15:13:16'),
(93, 4, 38, '2016-10-25 15:13:21');
...
INSERT INTO `npl`.`npl_sponsors` (`id`, `name`, `picture_name`, `link`, `written_datetime`) VALUES
...
INSERT INTO `npl`.`npl_srs_desktypes` (`id`, `name`, `color`, `written_datetime`) VALUES
...
INSERT INTO `npl`.`npl_srs_maps` (`id`, `lan_id`, `name`, `color`, `height`, `width`, `written_datetime`) VALUES
...
INSERT INTO `npl`.`npl_srs_seatpositions` (`id`, `name`, `position_x`, `position_y`, `written_datetime`) VALUES
...
INSERT INTO `npl`.`npl_srs_desks` (`id`, `map_id`, `desk_type_id`, `position_x`, `position_y`, `rotation`, `height`, `width`, `active`, `written_datetime`) VALUES
...
INSERT INTO `npl`.`npl_srs_seats` (`id`, `desk_id`, `seat_position_id`, `name`, `active`, `written_datetime`) VALUES
...
--
INSERT INTO `npl`.`npl_news` (`id`, `author_id`, `title`, `description`, `written_datetime`)
VALUES
