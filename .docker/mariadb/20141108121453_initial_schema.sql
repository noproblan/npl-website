...
CREATE TABLE IF NOT EXISTS `npl`.`npl_admin_resources` (
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_admin_rights` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_admin_roles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_admin_userroles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_errors` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_gal_albums` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_gal_albums_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `folder` varchar(255) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_laninfos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_laninfos_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lan_id` int(11) NOT NULL,
  `name` varchar(40) NOT NULL,
  `info` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_lans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_lans_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(40) NOT NULL,
  `start_datetime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `end_datetime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_oldusers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_resources` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `controller_name` varchar(20) NOT NULL,
  `action_name` varchar(20) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_resources_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `controller_name` varchar(20) NOT NULL,
  `action_name` varchar(20) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_rights` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_rights_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL,
  `resource_id` int(11) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_roles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_roles_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`,`written_datetime`),
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_sponsors` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_sponsors_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `picture_name` varchar(255) NOT NULL,
  `link` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_desks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_desks_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `map_id` int(11) NOT NULL,
  `desk_type_id` int(11) NOT NULL,
  `position_x` int(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_desktypes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_desktypes_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  `color` varchar(6) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_maps` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_maps_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lan_id` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `color` varchar(6) NOT NULL DEFAULT '000000',
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_seatpositions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_seatpositions_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  `position_x` int(11) NOT NULL,
  `position_y` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_seats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_seats_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `desk_id` int(11) NOT NULL,
  `seat_position_id` int(11) NOT NULL,
  `name` varchar(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_tickets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lan_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_srs_tickets_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lan_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `seat_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_userroles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `role_id` int(11) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_userroles_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `role_id` int(11) NOT NULL,
  `written_datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `npl`.`npl_users_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(20) NOT NULL,
  `password` varchar(40) NOT NULL,
  `salt` varchar(40) NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `npl`.`npl_view_users` (
`id` int(11)
,`username` varchar(20)
);
-- --------------------------------------------------------
