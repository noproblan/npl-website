...
class Application_Model_Mapper_UserRolesMapper
{
    ...
    public function getDbTable ()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_UserRoles');
        }
        return $this->_dbTable;
    }

    public function save (Application_Model_UserRole $userrole)
    {
        $data = array(
                'id' => $userrole->getId(),
    ...
    public function delete (Application_Model_UserRole $userrole)
    {
    ...
    protected function _fetch ($resultSet)
    {
        $elements = array();
        foreach ($resultSet as $row) {
            $element = new Application_Model_UserRole();
    ...
    protected function _setValues ($row, Application_Model_UserRole $userrole)
    {
