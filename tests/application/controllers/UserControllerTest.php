...
class UserControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    public function testUserVerifyShouldBeInvalidWhenNoParameterIsGiven ()
    {
        ...
        $this->assertQueryContentContains('div', 
                'Die Verifizierungsanfrage ist ungültig.');
    }
    ...
    {
        $this->dispatch(
                '/user/verify/id/0/key/1234567890123456789012345678901234567890');
        $this->assertQueryContentContains('div', 
                'Die Verifizierungsanfrage ist ungültig.');
    }
    ...
    public function testUserVerifyShouldRedirectToIndexWhenUserIsAlreadyActivated ()
    {
        ...
        $this->dispatch(
                '/user/verify/id/3/key/731464e0660dae127d2fff8146db8b9cf4099b41');
        $this->assertRedirect();
    ...
    public function testUserActivateShouldBeInvalidWhenNoParameterIsGiven ()
    {
        ...
        $this->assertQueryContentContains('div', 
                'Die Aktivierungsanfrage ist ungültig.');
    }
    ...
    {
        $this->dispatch(
                '/user/activate/id/0/key/1234567890123456789012345678901234567890');
        $this->assertQueryContentContains('div', 
                'Die Aktivierungsanfrage ist ungültig.');
    }
    ...
    public function testUserActivateShouldRedirectToIndexWhenUserIsAlreadyActivated ()
    {
        ...
        $this->dispatch(
                '/user/activate/id/3/key/5c403b904568d9c068e78b97880cf995b67eaf44');
        $this->assertRedirect();
        $this->assertRedirectTo('/');
    }
